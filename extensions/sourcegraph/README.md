...
For example, you can configure `example.sourcegraph.app` as a URL and go to `example.sourcegraph.app/users/<USERNAME>/settings/tokens` to create an access token for use in this extension.

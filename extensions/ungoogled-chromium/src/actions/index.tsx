...
export async function getOpenTabs(useOriginalFavicon: boolean): Promise<Tab[]> {
  ...
  `);
    ...
    if ((err as Error).message.includes('Can\'t get application "Chromium"')) {
...
export async function openNewTab({
  ...
  const getOpenInProfileCommand = (profile: string) =>
    ...
    do shell script "open -na 'Chromium' --args --profile-directory=" & profile & " " & link
  `;
...
try
    do shell script "osascript -e 'exists application \\"Chromium\\"'"

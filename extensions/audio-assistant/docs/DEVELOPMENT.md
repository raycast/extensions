...
| --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| All       | Default sectioned List: available players, artists, tracks, then albums. Empty-query discovery previews at most five artists; typed search does not use that artist cap. Individual outputs precede group outputs. |

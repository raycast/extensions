...
export interface TVCTakeChartScreenshotAndCopyArgs extends TVCTakeChartScreenshotArgs {}

export async function TVCTakeChartScreenshotAndCopy(props: LaunchProps<{ arguments: TVCTakeChartScreenshotAndCopyArgs }>) {
  ...
  await TVCChangeChartInterval({ ...props, arguments: props.arguments as TVCChangeChartIntervalArgs });

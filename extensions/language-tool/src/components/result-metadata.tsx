...
export function ResultMetadata({ result, appliedSuggestions }: ResultMetadataProps) {
    ...
    <Detail.Metadata>
      ...
      {result.language && (
        <>
          ...
          <Detail.Metadata.Label title="Language" text={result.language.name} icon={Icon.Globe} />
        </>
      )}

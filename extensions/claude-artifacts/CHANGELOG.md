...
- The check that matters actually **runs your installed hook** against a throwaway `HOME` and a current-format URL, rather than confirming the file exists. Every structural check was green throughout the outage — only behaviour could have caught it

...
import { CustomAbilities, CustomModel, CustomProvider } from "../../providers/types";
...
export function ModelForm({ provider, model, onSave }: ModelFormProps) {
  ...
  const [abilities, setAbilities] = useState<CustomAbilities>(model?.abilities || {});
  ...
  const updateModelAbility = (abilityName: keyof CustomAbilities, supported: boolean) => {

export const tailwindColorsV3: Record<string, string> = {                     
  ...
  "stone-900": "#1c1917", "stone-950": "#0c0a09",                               
    "red-50": "#fef2f2", "red-100": "#fee2e2", "red-200": "#fecaca", "red-300": 
  "#fca5a5", "red-400": "#f87171", "red-500": "#ef4444", "red-600": "#dc2626",  
  "red-700": "#b91c1c", "red-800": "#991b1b", "red-900": "#7f1d1d", "red-950":  
  "#450a0a",                                                                    
  ...
  "cyan-900": "#164e63", "cyan-950": "#083344",                                 
    "sky-50": "#f0f9ff", "sky-100": "#e0f2fe", "sky-200": "#bae6fd", "sky-300": 
  "#7dd3fc", "sky-400": "#38bdf8", "sky-500": "#0ea5e9", "sky-600": "#0284c7",  
  "sky-700": "#0369a1", "sky-800": "#075985", "sky-900": "#0c4a6e", "sky-950":  
  "#082f49",                                                                    
  ...
  export const tailwindColorsV4: Record<string, string> = { ...tailwindColorsV3 
  };                                                                            
                                                                                
  export function getTailwindColors(version: "v3" | "v4"): Record<string,       
  string> {                                                                     
    return version === "v4" ? tailwindColorsV4 : tailwindColorsV3;              
  }

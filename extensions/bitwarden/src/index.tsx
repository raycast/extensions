...
import { BitwardenItem, Folder } from "./types";
...
export default function Bitwarden(): JSX.Element {
  ...
  const [state, setState] = useState<{ folders: Folder[]; items: BitwardenItem[] }>();
...
function ItemListItem(props: { item: BitwardenItem; folders: Folder[]; additionalActions?: ActionPanelChildren[] }) {

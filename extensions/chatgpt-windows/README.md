...
<h1 align="center">ChatGPT (Windows)</h1>

<h3 align="center">
Interact with OpenAI's ChatGPT right from your command bar on Windows 11 and later.

> Windows notes: the selected-image commands pull files from the active File Explorer window. Copying an image to the clipboard also works for vision prompts.
</h3>

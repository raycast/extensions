# Raycast Binance Projects — Plan

## Goal

A Raycast extension that lets Hugo fly through creative project folders for Binance work. From a single fuzzy-search list, jump into Finder, open the project's Asana task / Google Drive folder / Frame.io review link, or open Magic Link Machine to manage missing links.

## Source of truth

- Root: `/Users/hugo/Sync/Gdrive/Projects/Binance/` (configurable via preference; was `…/2026/` in v0 sketch).
...
- `<List.Section title="2026">` — projects under `Binance/2026/`, sorted by **mtime descending**.
...
- `projectsRoot` (`directory`, default `/Users/hugo/Sync/Gdrive/Projects/Binance`) — root containing year folders.
...
- Creating new project folders — that's `binance-folder-generator`.
...
README.md
AGENTS.md
plans/raycast-binance-extension.md
```

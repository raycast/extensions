...
After install, Raycast asks for **Projects Root**. Point it at the parent of your year folders, for example `…/Binance`, not `…/Binance/2026`.
...
**Search Binance Projects** lists every project under the configured root. Open a project to get a grid of links and subfolders.

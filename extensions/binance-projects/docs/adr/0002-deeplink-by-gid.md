...
```
raycast://extensions/hugo/binance-projects/search-projects?context=<urlencoded JSON>
```
...
`props.launchContext` inside the command. The `hugo/binance-projects` segments come from

...
export const securityTweaks: TweakDefinition[] = [
  ...
  {
    id: "security-limit-ad-tracking",
    title: "Limit Ad Tracking",
    description: "Prevent advertisers from using your Apple ID for ad targeting",
    category: "security",
  ...
  {
    id: "security-personalized-ads",
    title: "Personalized Apple Ads",
    description: "Allow Apple to deliver personalized ads in App Store, Apple News, and Stocks",
    category: "security",
    domain: "com.apple.AdLib",

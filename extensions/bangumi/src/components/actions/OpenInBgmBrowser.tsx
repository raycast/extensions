...
export const OpenInBgmBrowser = ({ path, url, isPrimary, shortcut, ...props }: OpenInBgmBrowserProps) => {
  const finalUrl = url || (path ? `https://bgm.tv/${path}` : "https://bgm.tv")
  const defaultShortcut: Keyboard.Shortcut | undefined = isPrimary ? undefined : { modifiers: ["cmd"], key: "o" }

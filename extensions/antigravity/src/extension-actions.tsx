...
import { getAntigravityCLI } from "./lib/antigravity";
...
export function OpenExtensionByIDInAntigravityAction(props: {
  extensionID: string;
  ...
  return (
    <Action.OpenInBrowser
      ...
      url={`antigravity:extension/${props.extensionID}`}
      icon={"icon.png"}
      onOpen={(url) => {
        showHUD("Open Antigravity Extension");
        if (props.onOpen) {
          props.onOpen(url);
        }
      }}
...
export function OpenExtensionByIDInBrowserAction(props: { extensionID: string }): JSX.Element {
  ...
  return (
    <Action.OpenInBrowser
      ...
      onOpen={() => {
        showHUD("Open Antigravity Extension in Browser");
      }}
    />
  );
}

...
- **Model selection** — Choose between GPT 5.4 Mini and GPT 5.4 per query
...
| Model | Description |
|---|---|
| **GPT 5.4 Mini** | Default model for faster, lower-cost queries |
| **GPT 5.4** | Full-capability alternative for broader tasks |

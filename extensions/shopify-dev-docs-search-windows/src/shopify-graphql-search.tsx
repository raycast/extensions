    ...
    <List
      ...
      searchBarAccessory={
        <CategoryDropdown
          ...
          onCategoryChange={(newId) => setCategory(newId)}
        />
      }
          ...
          actions={
            <ActionPanel>
              <Action.OpenInBrowser
                url={`https://shopify.dev${item.url}`}
              ...
              metadata={
                <List.Item.Detail.Metadata>
                  <List.Item.Detail.Metadata.Label
                    title={item.pretty_breadcrumbs || ""}
                  />
                  <List.Item.Detail.Metadata.Label
                    title="Type"
                    text={item.object_label || "N/A"}
                  />
                  <List.Item.Detail.Metadata.Label
                    title="Category"
                    text={item.content_category || "N/A"}
                  />
                  <List.Item.Detail.Metadata.Label
                    title="API Version"

...
- Instant hotkey commands: Play/Pause, Next, Previous, Stop, Raise/Lower Volume
- Play Station command with Quicklink support: turn any station into a root-level Raycast item with its own alias or hotkey
- Daemon lifecycle: auto-start on demand, plus explicit Start/Quit commands

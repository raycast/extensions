...
function ReceivedMessages() {
    ...
    (0, react_1.useEffect)(() => {
        async function loadMessages() {
            try {
                const receivedMessages = await (0, claudeMessages_1.getReceivedMessages)();
    ...
    return ((0, jsx_runtime_1.jsx)(api_1.List, { isLoading: isLoading, searchBarPlaceholder: "Search Claude's responses...", children: (0, jsx_runtime_1.jsxs)(react_1.Fragment, { children: [messages.length === 0 && !isLoading && ((0, jsx_runtime_1.jsx)(api_1.List.EmptyView, { title: "No messages found", description: "No received messages found in your Claude history" })), messages.map((message) => ((0, jsx_runtime_1.jsx)(api_1.List.Item, { title: message.preview, subtitle: message.timestamp.toLocaleString(), accessories: [

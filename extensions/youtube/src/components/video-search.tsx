...
import * as cache from "./cached-videos";
import { Preferences } from "../lib/types";

const { gridColumns, showRecentVideos } = getPreferenceValues<Preferences>();

export function SearchVideoList({ channelId }: { channelId?: string }) {

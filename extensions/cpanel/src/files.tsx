...
function ViewFile({ dir, file }: { dir: string; file: string }) {
  ...
  return <Detail isLoading={isLoading} markdown={markdown} navigationTitle={`View Files > ${dir}/${file}`} actions={<ActionPanel>
    {!isLoading && data && <Action.CopyToClipboard content={data.content} />}
  </ActionPanel>} />;
}

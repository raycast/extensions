...
type NodeVersionDetailProps = {
  version: string;
  tagListItemPropsList?: React.ComponentProps<typeof Detail.Metadata.TagList.Item>[];
};

export function NodeVersionDetail({ version, tagListItemPropsList }: NodeVersionDetailProps) {
      ...
      metadata={
        data && (
          <Detail.Metadata>
            ...
            {tagListItemPropsList?.length && (
              <>
                <Detail.Metadata.Separator />
                <Detail.Metadata.TagList title="">
                  {tagListItemPropsList.map((props) => (

...
export default function Command() {
  ...
  useEffect(() => {
    ...
    mobileApi
      .search(searchText, SubjectType.MOVIE, TabID.MOVIE)
      .then((results) => {
        if (results) {
          const seen = new Set<string>();
          const uniqueMovies = results.filter((m: SubjectItem) => {
          ...
          if (!isCancelled) setMovies(uniqueMovies);
        }
      })
      .catch((e) => {
        console.error(e);

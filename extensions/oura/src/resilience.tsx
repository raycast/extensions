...
export default function Command() {
  const resilience = oura(`usercollection/daily_resilience?start_date=${getDate(-14)}&end_date=${getDate()}`) as ResilienceResponse;
      ...
      {resilienceDays.map((resilience) => (
				<List.Item 
					...
					accessories={[
						...
						{ text: {value: `Daytime: ${resilience.contributors.daytime_recovery}`, color: Color.Green}, icon: Icon.Sun },

...
import { getWebhookDetails, getWorkflowUrl } from "./utils/workflow-utils"; // Add getWorkflowUrl
import SaveCommandForm from "./components/SaveCommandForm"; // Add missing import
import { ActionOpenPreferences } from "./components/action-open-preferences"; // For error view
import TriggerFilterForm from "./components/TriggerFilterForm"; // Import the filter form
import { TRIGGER_FILTERS_KEY, FILTER_APPLIED_INDICATOR } from "./utils/constants"; // Import filter key and indicator
...
export default function SearchWebhookWorkflowsCommand() {
  ...
  const [allWorkflows, setAllWorkflows] = useState<Workflow[]>([]); // Store all fetched workflows before filtering

 ...
 */
function isValidSavedCommand(command: any): command is SavedCommand {
  return (
    command &&
    ...
    (command.headers === undefined || typeof command.headers === 'string') &&
    (command.queryParams === undefined || typeof command.queryParams === 'string') &&
    (command.body === undefined || typeof command.body === 'string')
  );
}

...
import { getAllWorkflowsAPI } from "../utils/n8n-api-utils"; // Import the new API function
import { Workflow } from "../types/types"; // Keep Workflow type
import { getIsShowDetail } from "./hooks/hooks"; // Keep this hook for detail view logic
    ...
    return (
        <List>
            <List.EmptyView
                ...
                actions={
                    <ActionPanel>
                        <Action.OpenCommandPreferences title="Open Preferences" />
  ...
  return (
    ...
    >
      {filteredWorkflows.length === 0 && !loading ? (
         <EmptyView title={"No Workflows Found"} />
      ) : (
        <>

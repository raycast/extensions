...
export default function SaveCommandForm(props: SaveCommandFormProps) {
  console.log("SaveCommandForm: Rendering"); // Add log here
  const { method, url, headers, queryParams, body } = props;
  ...
  return (
    ...
    >
      ...
      {/* Optionally display headers/query/body here for confirmation? */}
      <Form.Separator />
      <Form.TextField
        id="name"
        title="Command Name"

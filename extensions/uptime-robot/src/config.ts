...
export const MONITOR_TYPES: Record<string, { title: string; info: string; url: { title: string; placeholder: string } }> = {
  "1": {
  ...
  "3": { title: "Ping monitoring", info: "Make sure your server or any device in the network is always available.", url: {

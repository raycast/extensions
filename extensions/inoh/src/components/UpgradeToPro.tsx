...
const MARKDOWN = `# Unlock Inoh Pro 🚀
    ...
    <Detail
      ...
      metadata={
        <Detail.Metadata>
          ...
          <Detail.Metadata.TagList title="Inoh Pro Annual">
          ...
          <Detail.Metadata.Label title="Inoh Pro Monthly" text="$7.99 / mo" />
          <Detail.Metadata.Separator />
      ...
      actions={
        <ActionPanel>
          ...
          />
          <Action.OpenInBrowser title="Manage in the Inoh App" icon={Icon.Mobile} url={APP_STORE_URL} />
        </ActionPanel>
      }
    />
  );

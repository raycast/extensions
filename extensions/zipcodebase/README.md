...
2. **Get your Access Key**: The first time you use the extension, you'll need to enter your Zipcodebase API access key:
    ...
    a. `Sign in to your Zipcodebase Dashboard` at [this link](https://app.zipcodebase.com/login) OR `Create an account` at [this link](https://app.zipcodebase.com/register)

    b. `Navigate` to [Dashboard](https://app.zipcodebase.com/)

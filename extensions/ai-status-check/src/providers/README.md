...
| Claude, Moonshot AI, MiniMax, Cerebras, Baseten                         | Statuspage-compatible adapter | Published summary, components, incidents, scheduled maintenance, and rendered `uptimeData`                                                   |

import { Action, ActionPanel, Alert, Clipboard, confirmAlert, Form, Icon, Keyboard, List, showToast, Toast, useNavigation } from "@raycast/api";
...
export default function ManageSecrets() {
    const { isLoading, data: secrets, error, revalidate, mutate } = useFetch(API_URL + "secrets", {
        headers,
        parseResponse,
    ...
    return <List isLoading={isLoading}>
        {!isLoading && !secrets.length && !error ? <List.EmptyView title="You don't have any secrets yet" description="Secrets enable you to secure your code by removing hardcoded credentials and let you pass environment variables securely to your applications" actions={<ActionPanel>

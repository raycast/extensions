...
The new validator permits only skill directories immediately inside `skills/`. Shared tool/research documentation moved to `docs/skills/`, with relative links repaired. The catch-up title now uses the validator’s expected capitalization.

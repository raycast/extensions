...
Questions to ask yourself at the end of each year.

This small Raycast extension surfaces a curated set of 40 reflective questions intended for an end-of-year review. It provides two commands (see `package.json`):

- **Answer 40 Questions** — shows a form-like interface to submit answers.

...
const instructionTarget = `You target language is ${second_language} only if the provided text is in ${first_language}. Otherwise, the target language is ${first_language}.`;

...
export default function scoresAndSchedule() {
  const { isLoading: nflStandingsStats, data: nflStandingsData } = useFetch(
  ...
  const americanFootballConference = items1.map((team1, index) => {
    return (
      <List.Item
        ...
        accessoryTitle={`${team1.stats[16].displayValue} | Pct: ${(team1.stats[10].displayValue * 100).toFixed(1)}% | PF: ${team1.stats[7].displayValue} | PA: ${team1.stats[6].displayValue} | Dif: ${team1.stats[5].displayValue}`}
  ...
  const nationalFootballConference = items2.map((team2, index) => {
    return (
      <List.Item
        ...
        accessoryTitle={`${team2.stats[16].displayValue} | Pct: ${(team2.stats[10].displayValue * 100).toFixed(1)}% | PF: ${team2.stats[7].displayValue} | PA: ${team2.stats[6].displayValue} | Dif: ${team2.stats[5].displayValue}`}

...
const buildMarkdown = (data: DealBriefing | undefined, isLoading: boolean, error: Error | undefined): string => {
  if (isLoading) return "# Today's Briefing\n\n_Pulling together your pipeline…_";
      ...
      metadata={
        data ? (
          <Detail.Metadata>
            ...
            />
            <Detail.Metadata.Label title="Generated" text={data.generatedDate} />
          </Detail.Metadata>
        ) : undefined
      }
      actions={

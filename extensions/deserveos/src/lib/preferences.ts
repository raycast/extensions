...
export const getWorkspaceUrl = (): string => stripTrailingSlash(getPreferenceValues<Preferences>().workspaceUrl);
...
export const getApiBaseUrl = (): string => {
  ...
  return stripTrailingSlash(apiBaseUrl && apiBaseUrl.trim().length > 0 ? apiBaseUrl : "https://app.deserveos.com");
};

import { Action, ActionPanel, Detail, Form, PreferenceValues, Toast, getPreferenceValues, showToast, useNavigation } from "@raycast/api";
...
export default function Command() {
  ...
  return (
    ...
    >
      <Form.TextArea id="command" title="Command" />
    </Form>
  );
}

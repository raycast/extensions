...
export async function fetchFromCacheOrNetwork(): Promise<ProviderResult[]> {
...
/** Write results to cache. Used by refresh-usage and after fetch in fetchFromCacheOrNetwork. */
export function writeCache(results: ProviderResult[]): void {
...
export function getCachedData(): string | undefined {
  return cache.get(CACHED_DATA_KEY);
}

export function getLastFetchKey(): string | undefined {
...
export function getLastUpdatedFormatted(): string | null {

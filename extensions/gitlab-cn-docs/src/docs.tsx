...
const apiUrl =
  "https://gy2ugali5y-dsn.algolia.net/1/indexes/*/queries?x-algolia-application-id=GY2UGALI5Y&x-algolia-api-key=096228c4be1439a9d10a74ba33295a4d";
...
export default function Command() {
  ...
  return (
    <List
      ...
      searchBarPlaceholder="搜索极狐 GitLab 文档..."
      throttle
    >

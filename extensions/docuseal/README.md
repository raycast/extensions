<p align="center">
    <img src="./assets/docuseal.png" width="150" height="150" />
</p>

# DocuSeal

This is a Raycast extension for [DocuSeal](https://www.docuseal.com/) - _Open Source Document Signing_.

## 🚀 Getting Started

1. **Install extension**: Click the `Install Extension` button in the top right of [this page](https://www.raycast.com/xmok/docuseal) OR `install` via Raycast Store

    <a title="Install docuseal Raycast Extension" href="https://www.raycast.com/xmok/docuseal"><img src="https://www.raycast.com/xmok/docuseal/install_button@2x.png?v=1.1" height="64" alt="" style="height: 64px;"></a>

2. **Get your DocuSeal URL**:

    - If you are using DocuSeal from the website, use the default URL i.e. `https://api.docuseal.com` OR `https://api.docuseal.eu`
    - If you are self-hosting, enter the fully-qualified URL e.g. `https://docuseal.example.com`

3. **Get your DocuSeal API Token**:

    `Find`: **API** in **Settings**
...
<a title="Install papra Raycast Extension" href="https://www.raycast.com/xmok/papra"><img src="https://www.raycast.com/xmok/papra/install_button@2x.png?v=1.1" height="64" alt="" style="height: 64px;"></a>

...
export function TodoForm(props: { onCreate: (todo: Todo) => void, defaultTitle?: string, topPriority?: boolean, todo?: Todo }) {
  ...
  return (
    <Form
      actions={
        <ActionPanel>
          <Action.SubmitForm title={props.todo ? "Edit To-do" : "Create To-do"}

      ...
      {props.todos.map((todo, index) => (
        <List.Item
          ...
          actions={
            <ActionPanel>
              <ActionPanel.Section>
                <ToggleTodoAction todo={todo} onToggle={() => props.OnToggle(index)} />
                <EditTodoAction
                  todo={todo}
              ...
              <ActionPanel.Section>
                <CreateTodoAction onCreate={props.OnCreate} defaultTitle={props.searchText} />
                <CreateTopPriorityTodoAction

...
export function RestoreBackupAction(props: { set_todos: (todo: Todo[]) => void, set_dones: (todo: Todo[]) => void}) {

  async function OnImport() {
    if (!await confirmAlert({
      title: "Are you sure?",
      message: "Are you sure you want to restore the selected backup? This will remove all your current todos"
    })){
  ...
  return (
    <Action title="Restore a selected backup"

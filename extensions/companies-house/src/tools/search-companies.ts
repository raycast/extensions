...
type Input = {
  /** The company name or company number to search for. */
  query: string;
};

/** Search the UK Companies House register for companies by name or number. Returns up to 20 matches with their company number, status and registered address. */

...
export default function Command() {
    ...
    const commaListItems = [
        ...
        <List.Section title={"Floating Point Binary Representation — Single Precision"}>
            ...
            <List.Item title={"Floating Point Decimal"} accessories={[{ text: state.binFloat?.singlePrecision.floatDecimal }]} />
        </List.Section>,
        <List.Section title={"Floating Point Binary Representation — Double Precision"}>
            ...
            <List.Item title={"Floating Point Decimal"} accessories={[{ text: state.binFloat?.doublePrecision.floatDecimal }]} />
        </List.Section>,
    ];

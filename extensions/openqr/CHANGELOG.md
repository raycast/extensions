...
- Generate Static QR Code: encode any text or URL, choose PNG or SVG, set the pixel size and optional foreground/background colours, then copy the image, save it, or open it.

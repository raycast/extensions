...
export default function Command(): JSX.Element {
    return ResultView(
        preferences.ollamaImproveWriting,
        initalPrompt.get(promptTemplateFormat.get(preferences.ollamaImproveWriting) as string) as string,
        endPrompt.get(promptTemplateFormat.get(preferences.ollamaImproveWriting) as string) as string,
        true
    );
}

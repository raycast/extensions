import { StateMachineListItem, SFNClient, ListStateMachinesCommand, StateMachineType } from "@aws-sdk/client-sfn"; // ES Modules import
...
function StateMachine({ item }: { item: StateMachineListItem }) {
  return (
    <List.Item
      ...
      title={item.name || ""}
      accessories={[{ text: item.type || StateMachineType.STANDARD }]}
      actions={
        <ActionPanel>

...
This project includes a comprehensive test suite with 77 tests covering all non-standard math functions and expression parsing logic.
...
### 9. **Angle Conversions and Modes** - 8 tests

- **deg2rad**: Degrees to radians conversion
- **rad2deg**: Radians to degrees conversion
- Negative angle handling for both
- Degree- and radian-mode trigonometric functions
- Inverse trigonometric output conversion
- Shared mode toggling and preference reset behavior

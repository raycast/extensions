...
export default function Command() {
    const initItem =
        <List.Item key="addNewArg" title="Add New Arg" icon="add.png" actions={
            <ActionPanel>
                <Action.Push title="Add New Arg"
                             target={<AddArgCommand/>}/>
            </ActionPanel>
        }/>
    ...
    useEffect(() => {
        async function f() {
            ...
            for (const arg of argList) {
                ...
                temp.push(
                    <List.Item key={arg} title={arg} icon="list-item.png" actions={
                        <ActionPanel>
                            <Action.Push title="Edit Arg"
                                         target={<EditArgValueList argName={arg} argValueList={argValueList}/>}/>
                            <Action.Push title="Rename Arg"
                                         target={<EditArgCommand oldArgName={arg}/>}/>
                            <Action title="Delete Arg" onAction={async () => {

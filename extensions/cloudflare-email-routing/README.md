...
A Raycast extension that allows you to create, list, edit, and delete [Cloudflare](https://www.cloudflare.com/) email aliases directly from Raycast. 
...
3.  **API Token**: A Cloudflare API token with the necessary "Email Routing" and "Zone" permissions.
...
-   **Cloudflare API Key**: Your API token with following permissions:
    ...
    1. `Email Routing Addresses:Edit`
    2. `Email Routing Rules:Edit`
    3. `Zone Settings:Read`

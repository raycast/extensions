...
<h1 align="center">OpenRouter</h1>

<h3 align="center">
Interact with OpenRouter right from your command bar
</h3>
...
This extension requires a valid `Secret Key` as your API Key from [OpenRouter](https://openrouter.ai/settings/keys).
...
All preferences properties list that can be customize through `Raycast Settings > Extensions > OpenRouter`

| Properties               | Label                  | Value                               | Required | Default                     | Description                                                                                                      |
| ------------------------ | ---------------------- | ----------------------------------- | -------- | --------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| `apiKey`                 | API Key                | `string`                            | `true`   | `empty`                     | Your personal OpenRouter API key                                                                              |
...
| `useApiEndpoint`         | Use API Endpoint       | `boolean`                           | `false`  | `false`                     | Change the OpenRouter's default API endpoint to custom endpoint                                                      |

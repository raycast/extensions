...
- Feature: Forked and migrated from Google's Gemini to OpenRouter using OpenAI-compatible API.
- Chore: Updated documentation and preferences to reflect OpenRouter integration.

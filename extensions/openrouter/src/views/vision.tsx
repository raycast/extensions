...
const visionModelName: string = (preferences.useVisionModel && preferences.visionModelName) || "openrouter/auto";
...
export function VisionView(props: AskImageProps) {
  ...
  async function getChatResponse(prompt: string) {
    try {
      ...
      const streamOrCompletion = await openrouter.chat.completions.create({

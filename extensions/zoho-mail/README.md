<p align="center">
    <img src="./assets/zoho-mail.png" width="200" height="200" />
</p>
...
2. **Connect your Zoho account**: The extension uses **OAuth** to allow you to securely log in:

    a. `Run` any command

    b. `Click` to **Sign in with Zoho** when prompted

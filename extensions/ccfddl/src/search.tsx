...
function ConferenceListItem({
  ...
  return (
    <List.Item
      ...
      subtitle={item.sub}
      accessories={[
        { text: `CCF: ${item.rank.ccf}` },
        { text: latestConf?.place || "Location unknown" },
      ]}
      actions={
        <ActionPanel>
          {latestConf?.link && (
        ...
        <List.Item.Detail
          ...
          metadata={
            <List.Item.Detail.Metadata>
              ...
              <List.Item.Detail.Metadata.Label
                title="CCF Rank"
                text={item.rank.ccf || "N/A"}
              />
              <List.Item.Detail.Metadata.Label
                title="CORE Rank"
                text={item.rank.core || "N/A"}
              />
              <List.Item.Detail.Metadata.Label
                title="THCPL Rank"
                text={item.rank.thcpl || "N/A"}
              />
              {latestConf && (
                <>
                  <List.Item.Detail.Metadata.Separator />

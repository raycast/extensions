...
import { DNSRecord, DNSRecordForm, Domain, ErrorResult } from "./types";
...
export const makeRequest = async <T>(endpoint: string, options?: RequestInit & {params?: { [key: string]: string | number }}) => {

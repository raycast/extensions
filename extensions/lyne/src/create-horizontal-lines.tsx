...
export default function Command() {
  ...
  return (
    <Form actions={<ActionPanel><Action.SubmitForm onSubmit={(values) => createHorizontalLines(values.horizontal_line_positions, values.horizontal_line_layout)} /></ActionPanel>}>
      <Form.Description

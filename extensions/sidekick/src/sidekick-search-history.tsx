import { List, showToast, popToRoot, ActionPanel, Action, Toast } from "@raycast/api";
import { getFavicon } from "@raycast/utils";
import { useState, ReactElement } from "react";
import { HistoryEntry, useSidekickHistorySearch } from "./browser/history";
...
const Actions = (props: { entry: HistoryEntry }): ReactElement => {
  ...
  return (
    <ActionPanel title={title}>
      <Action.OpenInBrowser title="Open in Browser" url={url} onOpen={onBrowserOpen} />

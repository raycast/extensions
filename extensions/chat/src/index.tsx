...
function SavedConversations() {
    ...
    const viewDetails = (conversation: Conversation) => {
        const conversationDetails = conversation.messages.map(msg => `Q: ${msg.question}\n\nA: ${msg.answer}`).join('\n\n');
...
export default function Command() {
    ...
    if (!isSetupComplete || !apiKey) {
        return (
            <Form actions={<ActionPanel><Action.SubmitForm title="Save API Key" onSubmit={(formValues) => handleApiKeySubmit(formValues.apiKey)} /></ActionPanel>}>

...
const DUMMY_TASKS_WITH_PULL_REQUESTS: TaskWithPullRequest[] = [
  {
    ...
    task: {
      ...
      artifacts: [],
      archived_at: null,
      updated_at: minutesAgoISO8601Timestamp(5),
  ...
  },
  {
    ...
    task: {
      ...
      artifacts: [],
      archived_at: null,
      updated_at: minutesAgoISO8601Timestamp(10),
  ...
  },
  {
    ...
    task: {
      ...
      artifacts: [],
      archived_at: null,
      updated_at: minutesAgoISO8601Timestamp(180),
  ...
  },
  {
    ...
    task: {
      ...
      artifacts: [],
      archived_at: null,
      updated_at: minutesAgoISO8601Timestamp(5 * 60),
  ...
  },
  {
    ...
    task: {
      ...
      artifacts: [],
      archived_at: null,
      updated_at: minutesAgoISO8601Timestamp(60 * 8),
  ...
  },
  {
    ...
    task: {
      ...
      artifacts: [],
      archived_at: null,
      updated_at: minutesAgoISO8601Timestamp(60 * 11),
  ...
  },
  {
    ...
    task: {
      ...
      artifacts: [],
      archived_at: null,
      updated_at: minutesAgoISO8601Timestamp(60 * 35),
  ...
  },
  {
    ...
    task: {
      ...
      artifacts: [],
      archived_at: null,
      updated_at: minutesAgoISO8601Timestamp(60 * 50),

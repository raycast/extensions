    ...
    if(loading) {
        ...
        const moveDetail = moves?.map(item => 
            <List.Item.Detail.Metadata.TagList title={`${item.level}-${item.cn_name}`}>
                ...
                <List.Item.Detail.Metadata.TagList.Item text={`${item.damage_class}`} color={mapping.damageTypeColorMapping[`${item.damage_class}`]}/>
        ...
        return (
            <List isLoading={loading} isShowingDetail>
                <List.Item icon={IconList.name} title="名字" accessories={[{text: `${pokemonStatData.name}`}]} detail={
                    <List.Item.Detail markdown={`![illustration](${pokemonStatData.image})`}/>
                }/>
                <List.Item icon={IconList.number} title="编号" accessories={[
                ...
                <List.Item icon={IconList.generation} title="地区" accessories={[
                    {tag: {value: `${pokemonStatData.generation}`, color: mapping.generationColorMapping[`${pokemonStatData.generation}`]}}
                ]}/>
                <List.Item icon={IconList.stat} title="种族值" detail={
                    <List.Item.Detail metadata={
                        <List.Item.Detail.Metadata>
                            <List.Item.Detail.Metadata.TagList title="生命">
                                <List.Item.Detail.Metadata.TagList.Item text={"█".repeat(pokemonStatData.base_stats.hp / 10)} color={"#8AC653"}/>
                                <List.Item.Detail.Metadata.TagList.Item text={hp} color={"#8AC653"}/>
                            </List.Item.Detail.Metadata.TagList>
                            <List.Item.Detail.Metadata.TagList title="攻击">
                                <List.Item.Detail.Metadata.TagList.Item text={"█".repeat(pokemonStatData.base_stats.attack / 10)} color={"#F8CB3B"}/>
                                <List.Item.Detail.Metadata.TagList.Item text={attack} color={"#F8CB3B"}/>
                            </List.Item.Detail.Metadata.TagList>
                            <List.Item.Detail.Metadata.TagList title="防御">
                                <List.Item.Detail.Metadata.TagList.Item text={"█".repeat(pokemonStatData.base_stats.defense / 10)} color={"#D98837"}/>
                                <List.Item.Detail.Metadata.TagList.Item text={defense} color={"#D98837"}/>
                            </List.Item.Detail.Metadata.TagList>
                            <List.Item.Detail.Metadata.TagList title="特攻">
                                <List.Item.Detail.Metadata.TagList.Item text={"█".repeat(pokemonStatData.base_stats.special_attack / 10)} color={"#58C3D0"}/>
                                <List.Item.Detail.Metadata.TagList.Item text={special_attack} color={"#58C3D0"}/>
                            </List.Item.Detail.Metadata.TagList>
                            <List.Item.Detail.Metadata.TagList title="特防">
                                <List.Item.Detail.Metadata.TagList.Item text={"█".repeat(pokemonStatData.base_stats.special_defense / 10)} color={"#5890CD"}/>
                                <List.Item.Detail.Metadata.TagList.Item text={special_defense} color={"#5890CD"}/>
                            </List.Item.Detail.Metadata.TagList>
                            <List.Item.Detail.Metadata.TagList title="速度">
                                <List.Item.Detail.Metadata.TagList.Item text={"█".repeat(pokemonStatData.base_stats.speed / 10)} color={"#A456CF"}/>
                ...
                <List.Item icon={IconList.types} title="属性" detail={
                    <List.Item.Detail metadata={
                        <List.Item.Detail.Metadata>
                            <List.Item.Detail.Metadata.Label title="弱点"/>
                            <List.Item.Detail.Metadata.TagList title="受到4倍伤害">
                                {pokemonStatData.damage_relations.quadruple_damage_from.map(item => <List.Item.Detail.Metadata.TagList.Item text={item} color={mapping.cnColorMapping[item]}/>)}
                            </List.Item.Detail.Metadata.TagList>
                            <List.Item.Detail.Metadata.TagList title="受到2倍伤害">
                                {pokemonStatData.damage_relations.double_damage_from.map(item => <List.Item.Detail.Metadata.TagList.Item text={item} color={mapping.cnColorMapping[item]}/>)}
                            </List.Item.Detail.Metadata.TagList>
                            <List.Item.Detail.Metadata.Separator/>
                            <List.Item.Detail.Metadata.Label title="抗性"/>
                            <List.Item.Detail.Metadata.TagList title="受到1/2倍伤害">
                                {pokemonStatData.damage_relations.half_damage_from.map(item => <List.Item.Detail.Metadata.TagList.Item text={item} color={mapping.cnColorMapping[item]}/>)}
                            </List.Item.Detail.Metadata.TagList>
                            <List.Item.Detail.Metadata.TagList title="受到1/4倍伤害">
                                {pokemonStatData.damage_relations.quarter_damage_from.map(item => <List.Item.Detail.Metadata.TagList.Item text={item} color={mapping.cnColorMapping[item]}/>)}
                            </List.Item.Detail.Metadata.TagList>
                            <List.Item.Detail.Metadata.TagList title="免疫伤害">
                                {pokemonStatData.damage_relations.none_damage_from.map(item => <List.Item.Detail.Metadata.TagList.Item text={item} color={mapping.cnColorMapping[item]}/>)}
                            </List.Item.Detail.Metadata.TagList>
                            <List.Item.Detail.Metadata.Separator/>
                            <List.Item.Detail.Metadata.Label title="打击面"/>
                            <List.Item.Detail.Metadata.TagList title="强打">
                                {pokemonStatData.damage_relations.strong_damage_to.map(item => <List.Item.Detail.Metadata.TagList.Item text={item} color={mapping.cnColorMapping[item]}/>)}
                            </List.Item.Detail.Metadata.TagList>
                            <List.Item.Detail.Metadata.TagList title="弱打">
                                {pokemonStatData.damage_relations.weak_damage_to.map(item => <List.Item.Detail.Metadata.TagList.Item text={item} color={mapping.cnColorMapping[item]}/>)}
                            </List.Item.Detail.Metadata.TagList>
                        </List.Item.Detail.Metadata>
                    }/>
                } accessories={attrInfo}/>
                <List.Item icon={IconList.ability} title="特性" detail={
                    <List.Item.Detail metadata={
                        // <List.Item.Detail.Metadata>
                ...
                <List.Item icon={IconList.moves} title="技能" detail={
                    <List.Item.Detail metadata={
                        <List.Item.Detail.Metadata>

...
export async function GetStats(id: string, totalInfo: TotalInfo, pokemonStatData: PokemonStatData) {
    ...
    let statMap: {[key: string] : (value: number) => void } = {
        ...
        'special-attack': (value: number) => {pokemonStatData.base_stats.special_attack = value;},
        'special-defense': (value: number) => {pokemonStatData.base_stats.special_defense = value;},
        'speed': (value: number) => {pokemonStatData.base_stats.speed = value;}
    }

...
const threads = [
  {
    ...
    from: { name: 'Nora Lind', email: 'nora@example.com' },
    snippet: 'Attached is the invoice for September.',
    date: ago(20),
    unread: true,
    starred: false,
    hasAttachments: true,
  },
  {
    ...
    from: { name: 'Sam Ortiz', email: 'sam@example.com' },
    snippet: 'Looks good, one change to the timeline.',
    date: ago(300),
    unread: false,
    starred: true,
  ...
  },
  {
    ...
    from: { name: '', email: 'digest@news.example' },
...
const notes = [
  {
    ...
    snippet: 'Morning: roadmap. Afternoon: hiring.',
    updatedAt: ago(90),
    links: [],
  },
  {
    id: 'n2',
    title: 'Reading list',
    snippet: 'A Philosophy of Software Design',
    updatedAt: ago(60 * 48),
    links: [],
  },
]
...
switch (cmd) {
    ...
    out(
      empty
        ...
        : {
            total: 2,
            accounts: [
              { id: 'a1', email: 'me@work.example', unread: 1 },
              { id: 'a2', email: 'me@home.example', unread: 1 },
            ],
          },
    )
  case 'inbox':
  ...
  case 'search': {
    ...
    out(
      empty
        ? []
        : limit(threads.filter((t) => [t.subject, t.snippet, t.from.name, t.from.email].some(match(q)))),
    )
  }
  case 'today':
  case 'agenda':
        ...
        : [
            {
              ...
              allDay: false,
              organizer: { name: 'Sam Rivera', email: 'sam@example.com' },
              accountId: 'a1',
              threadId: 't2',
            },
          ],

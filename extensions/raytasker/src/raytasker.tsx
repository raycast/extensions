...
export default function Command() {
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        await google.fetchLists().then(async (list) => {
  ...
  function filterTasks(listId: string) {
    ...
    const newFilteredTasks = allTasks.filter((task) => !task.parent && !task.completed && task.list == listId);
            ...
            <List.Item.Detail
              ...
              metadata={
                <List.Item.Detail.Metadata>
                  <List.Item.Detail.Metadata.Label title="Title" text={task.title} icon={Icon.Dot} />

...
Minimalist Linux command and AI prompt management

- Easily add and locate commands and prompts
- Quick paste prompts into large language models
- Supports clipboard and variable placeholders
- Chinese Pinyin fuzzy search functionality
- Sync commands and prompts across devices by hosting the data file with WebDAV tools

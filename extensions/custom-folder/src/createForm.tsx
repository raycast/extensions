...
export default function CreateForm() {
  ...
  return (
    ...
    >
      ...
      />
      <Form.FilePicker id="output" title="Output path" allowMultipleSelection={false} canChooseDirectories canChooseFiles={false} info={"Optional output path (default is image path)."} />
      <Form.TextField
        id="padding" title={"Padding"}
        defaultValue="45" info={"Optional image padding parameter (default is 45)."}
        error={paddingError}

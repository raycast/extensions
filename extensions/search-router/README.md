...
Quickly add a new custom search engine with a personalized trigger and URL. Custom engines allow you to:

- Create shortcuts for websites not included in Kagi's bang list
- Want to add custom search engines directly in the extension? You can now do this with the "Browse Search Engines" command (with built-in filtering) or the quick "Add Custom Search Engine" command! 🎉 This allows you to add personal or work-specific search engines without needing to contribute to Kagi's repository.
- Customize existing search engines with your preferred parameters

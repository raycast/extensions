...
/**
 * Prevents your PC from going to sleep for a specified duration
 */
export default async function (input: Input) {
  ...
  await startCaffeinate({ status: true }, undefined, { durationSeconds: totalSeconds });

  return `PC will stay awake for ${formattedTime}`;
}

...
type TextComponent = <C extends React.ElementType = "div">(props: TextProps<C>) => React.ReactElement;

const Text: TextComponent = forwardRef(
  <C extends React.ElementType = "div">({ bold, component, ...others }: TextProps<C>, ref: PolymorphicRef<C>) => {

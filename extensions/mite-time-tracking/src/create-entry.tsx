...
export default function CreateEntry() {
  ...
  async function handleSubmit(values: {
    ...
    const totalMinutes = parseInt(values.minutes) || 0;

    if (totalMinutes <= 0) {
      await showToast({
        style: Toast.Style.Failure,
        title: "Duration Required",
        message: "Please enter minutes greater than 0",
      });
      return;
    }
    ...
    try {
      ...
      // Create time entry (without starting tracker)
      ...
      await showToast({
        ...
        title: "Entry Created",
        message: `${projectName} - ${totalMinutes}min`,
      });
  ...
  return (
    ...
    >
      ...
      <Form.DatePicker
        ...
        max={new Date()}
        info="Select the date for this entry (today or earlier)"
      />
      ...
      <Form.TextField
        ...
        info="Enter the duration in minutes (e.g., 90 for 1.5 hours)"
      />

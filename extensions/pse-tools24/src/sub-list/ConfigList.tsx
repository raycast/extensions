...
export default function ConfigList({
  ...
  [index: string]: { index: string; value: string; rules: { value: string | object }[] }[];
}) {
        ...
        <List.Item
          ...
          actions={
            <ActionPanel title="Actions">
              <Action.CopyToClipboard title="Copy to Clipboard" content={detail} />
            </ActionPanel>
          }
        />
      );
  ...
  return <List isShowingDetail>{buildConfigItems()}</List>;
}

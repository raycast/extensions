...
export default function Command() {
  function handleSubmit(values: Values) {
    ...
    switch (values.dropdown) {
      case "merge-file-text-item":
        ...
        showToast({ title: "合并成功", message: "查看:"+values.outPath+"/output.txt" });
        break;
    }
  }
  ...
  return (
    ...
    >
      ...
      <Form.TextField id="inPath" title="输入目录" placeholder="输入文件的目录"  />
      <Form.TextField id="extName" title="文件类型" placeholder=".java" defaultValue=".java" />
      <Form.TextField id="outPath" title="输出目录" placeholder="输出文件的目录" />
      ...
      <Form.Dropdown id="dropdown" title="选择功能">
        <Form.Dropdown.Item value="merge-file-text-item" title="合并所有文件内容到一个文件" />
      </Form.Dropdown>

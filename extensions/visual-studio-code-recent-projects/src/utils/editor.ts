...
const bundleIdMap: Record<string, { macos: string; windows: { name: string; exe: string } }> = {
  ...
  "Code - Insiders": { macos: "com.microsoft.VSCodeInsiders", windows: { name: "", exe: "" } },
  Cursor: { macos: "com.todesktop.230313mzl4w4u92", windows: { name: "", exe: "" } },
  Kiro: { macos: "dev.kiro.desktop", windows: { name: "", exe: "" } },
  Positron: { macos: "com.rstudio.positron", windows: { name: "", exe: "" } },
  Trae: { macos: "com.trae.app", windows: { name: "", exe: "" } },
  "Trae CN": { macos: "cn.trae.app", windows: { name: "", exe: "" } },
  VSCodium: { macos: "com.vscodium", windows: { name: "VSCodium", exe: "VSCodium.exe" } },
  "VSCodium - Insiders": { macos: "com.vscodium.VSCodiumInsiders", windows: { name: "", exe: "" } },
  Windsurf: { macos: "com.exafunction.windsurf", windows: { name: "", exe: "" } },
};

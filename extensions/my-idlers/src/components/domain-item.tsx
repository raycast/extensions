...
export default function DomainItem({ domain }: { domain: Domain }) {
    ...
    return <List.Item icon={getFavicon(url, { fallback: Icon.Globe })} title={title} detail={<List.Item.Detail metadata={<List.Item.Detail.Metadata>
        <List.Item.Detail.Metadata.Label title="Domin" text={title} />

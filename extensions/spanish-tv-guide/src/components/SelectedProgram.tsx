...
import { truncate, truncateForMetadata } from "../utils/stringUtils";
  ...
  return (
    program && (
      <Detail
        ...
        metadata={
          <Detail.Metadata>
            <Detail.Metadata.Label title={truncateForMetadata(channel.name)} icon={channel.icon} />
            <Detail.Metadata.Label title={truncateForMetadata(program.name)} />
          </Detail.Metadata>
        }
      />
    )

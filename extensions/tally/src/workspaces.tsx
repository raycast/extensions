...
export default function Workspaces() {
    ...
    return <List isLoading={isLoading}>
        {workspaces.map(workspace => <List.Item key={workspace.id} icon={Icon.Folder} title={workspace.name || "My workspace"} accessories={[
            ...
            <Action.Push icon={Icon.Pencil} title="Update Workspace" target={<RenameWorkspace workspace={workspace} onRename={revalidate} />} />
        </ActionPanel>} />)}
    </List>
}

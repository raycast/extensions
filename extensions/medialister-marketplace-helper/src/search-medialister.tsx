import { ActionPanel, Form, Action, showToast, Toast, Detail, AI, Clipboard, open } from "@raycast/api";
...
export default function AskRaycastAI() {
  ...
  **Do not come up with new IDs that are not available in the provided JSON attachments.**
  ...
  -  Social Traffic as a Percentage of Visits (mediaProject_seoMetric.sourceSocial)
  ...
  **KEEP in mind that filters are put into "mediaProject.seoMetric" but columns and sorting options are in "mediaProject_seoMetric" and always check for it.**
  ...
  const handleSubmit = async () => {
    if (!userInput) {
      showToast(Toast.Style.Failure, "Please enter a request");
      return;
    }
  ...
  return (
    ...
    >
      <Form.TextArea
        ...
        placeholder="What do you want to promote? Specify the targeted geography, price per placement, media website metrics, such as Ahrefs Domain Rating, and other information."
        value={userInput}

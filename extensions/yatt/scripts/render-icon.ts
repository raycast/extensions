/**
 * Renders assets/icon-source.svg to assets/extension-icon.png (512×512, transparent rounded corners).
...
const svg = readFileSync(path.join(root, "assets", "icon-source.svg"), "utf8");

...
import { activatePane, focusWezTerm, spawnTab, switchWorkspace } from "./utils/wezterm";
...
export default function CreateTab() {
  ...
  return (
    ...
    >
      ...
      />
      <Form.Dropdown id="workspace" title="Workspace" info="Select a workspace to create the tab in.">

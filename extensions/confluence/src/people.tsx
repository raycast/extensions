...
export default function People() {
    ...
    const titleText = state.isSearched
        ? "Search Results"
        : (state.typeFilter == DEFAULT_TYPE_FILTER ? "People" : 'Apps');
...
async function performSearch(site: Site, searchText: string, typeFilter: string, signal: AbortSignal): Promise<SearchResult[]> {

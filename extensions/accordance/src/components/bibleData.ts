export interface BibleBook {
  name: string;
  abbrvs: string[]; // All common abbreviations for this book
  chapters: number;
  verses: number[];
}
...
export const bibleData: BibleBook[] = [
  ...
  },
  {
    ...
    abbrvs: ["1 Thess", "1 Thes"],
    chapters: 5,
    verses: [10, 20, 13, 18, 28],
  },
  {
    name: "2 Thessalonians",
    abbrvs: ["2 Thess", "2 Thes"],
    chapters: 3,
    verses: [12, 17, 18],
  },
  {

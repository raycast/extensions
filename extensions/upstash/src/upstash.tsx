...
export function OpenInUpstash({route}: {route: string}) {
  return <Action.OpenInBrowser icon="upstash-icon-dark-bg.png" title="Open in Upstash" url={`https://console.upstash.com/${route}`} shortcut={Keyboard.Shortcut.Common.Open} />
}
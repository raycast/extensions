...
export default function QwenTTSMenuBarStatus() {
  ...
  return (
    <MenuBarExtra icon={icon} title={title} isLoading={isLoading} tooltip="Qwen-TTS Status">
      {isActive && state ? (
        <>
      ...
      <MenuBarExtra.Section>
        <MenuBarExtra.Item
          title="Read with Qwen-TTS Voice"
          icon={Icon.SpeakerHigh}
          onAction={launch("qwen-read-with-voice")}
        />
        <MenuBarExtra.Item
          title="Set Qwen-TTS Quick Read Voice"
          icon={Icon.Star}
          onAction={launch("qwen-select-voice")}
        />

...
export default function OpenAIMenuBarStatus() {
  ...
  useEffect(() => {
    Promise.all([getNowPlaying(), getSpeedOverride(), getOpenAISettings()]).then(([s, r, settings]) => {
      setState(s);
      setOverride(r);
  ...
  return (
    <MenuBarExtra icon={icon} title={title} isLoading={isLoading} tooltip="OpenAI TTS Status">
      {isActive && state ? (
        <>
      ...
      <MenuBarExtra.Section>
        <MenuBarExtra.Item
          title="Open OpenAI TTS Studio"
          icon={Icon.Microphone}
          onAction={launch("openai-tts-studio")}
        />
        <MenuBarExtra.Item
          title="Read with OpenAI Voice"
          icon={Icon.SpeakerHigh}
          onAction={launch("openai-read-with-voice")}
        />
        <MenuBarExtra.Item
          title="Set OpenAI Quick Read Voice"
          icon={Icon.Star}
          onAction={launch("openai-select-voice")}
        />

...
- Offload local copies: verify a repository is fully pushed — branches, tags, and every commit reachable only locally — confirm any ignored files that cannot be re-downloaded, free the disk space, and keep a placeholder to restore it later, remotes and push URLs included

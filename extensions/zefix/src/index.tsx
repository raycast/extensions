  ...
  return <List.Item.Detail
    ...
    metadata={
      <List.Item.Detail.Metadata>
        ...
        <List.Item.Detail.Metadata.Label title="Legal Form" text={legalForms.find(f => f.id == item.legalFormId)?.name[language]} />
...
function entryActions(item: ZefixEntry) {
  return <ActionPanel>
    ...
    <Action.CopyToClipboard
      title="Copy UID"
      content={item.uidFormatted}
    />
    <Action.CopyToClipboard
      title="Copy MWST ID"
      content={`${item.uidFormatted} MWST`}
    />
  </ActionPanel>;
}

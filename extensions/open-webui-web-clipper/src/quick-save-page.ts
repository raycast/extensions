...
export default async function Command() {
  ...
  const toast = await showToast({ style: Toast.Style.Animated, title: "Saving Page and Starting Model…" });
  try {
    ...
    toast.title = result.warnings.length ? "Chat Created With Warning" : "Page Saved, Model Started";

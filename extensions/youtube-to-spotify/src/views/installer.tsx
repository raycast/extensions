...
const installGuide = (executable: string) => `
...
export default function Installer({ executable, onRefresh }: InstallerProps) {
  return <Detail actions={<AutoInstall onRefresh={onRefresh} />} markdown={installGuide(executable)} />;
}

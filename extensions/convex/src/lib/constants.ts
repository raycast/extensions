export const CONVEX_CLIENT_ID = "convex-panel-raycast-1.0.0";
export const AUTH_ISSUER = "https://auth.convex.dev";
export const AUTH_CLIENT_ID = "HFtA247jp9iNs08NTLIB7JsNPMmRIyfi";

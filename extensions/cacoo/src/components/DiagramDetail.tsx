...
import { type GetDiagramsResponse, getDiagramById, withApiKey } from "../api/cacoo";
    ...
    <Detail
      ...
      actions={
        <ActionPanel>
          ...
          <Action.CopyToClipboard title="Copy URL" content={diagram.url} shortcut={{ modifiers: ["cmd"], key: "u" }} />
        </ActionPanel>
      }
    />
  );

...
import { type GetDiagramsResponse, type GetOrganizationsResponse, withApiKey } from "../api/cacoo";
...
export const ListDiagrams = ({
  ...
  return (
    <Grid
      ...
      searchBarAccessory={
        organizationKey ? (
          <Grid.Dropdown tooltip="Organizations" value={organizationKey} onChange={onChangeOrganizationKey}>
            {organizations.map((organization) => (
              <Grid.Dropdown.Item key={organization.id} title={organization.name} value={organization.key} />
            ))}
          </Grid.Dropdown>
        ) : null
      }

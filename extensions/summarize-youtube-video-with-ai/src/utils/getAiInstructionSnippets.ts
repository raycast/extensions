...
export function getFollowUpQuestionSnippet(question: string, transcript: string) {
  return `The following text is the content of a video. Refer to it as video. You already summarized it for the person asking a question. Answer concisely and to the point. Use emojis where appropriate but keep the answer short. Ignore Sponsor Segments and Video Sponsors.

...
export function isReadyToFetch() {
  ...
  const hasMfaSessionCredentials = !!process.env.AWS_ACCESS_KEY_ID && !!process.env.AWS_SESSION_TOKEN;

  return isProfileSelected || isAwsVaultSessionActive || hasMfaSessionCredentials;
}

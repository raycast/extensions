...
interface SearchTabsBaseProps extends LaunchProps {
  getTabsFunction: () => Promise<Tab[] | undefined>;
}

export function SearchTabsBase(props: SearchTabsBaseProps) {
  ...
  const { data, isLoading, mutate } = useCachedPromise(props.getTabsFunction);

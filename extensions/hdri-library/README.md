...
A Raycast extension for browsing and downloading high-quality HDRI images from [Poly Haven](https://polyhaven.com), a curated public asset library for 3D artists and game designers.
...
1. Open Raycast and search for "Find HDRI"
2. Browse or search for HDRIs using the search bar
3. Use the filter dropdown to view All HDRIs, Favorites, or Downloaded items
4. Select an HDRI to see download options:
...
[**Support Poly Haven on Patreon →**](https://www.patreon.com/cw/polyhaven)

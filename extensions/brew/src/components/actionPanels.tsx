      ...
      <ActionPanel>
        ...
        <ActionPanel.Section>
          <Action.CopyToClipboard
            ...
            content={`brew uninstall --cask ${cask.name}`}
          ...
          <Action
            ...
            icon={Icon.Terminal}
            onAction={() => {
              runCommandInTerminal(`brew uninstall --cask ${cask.name}`);
            }}
          />
        </ActionPanel.Section>
        <ActionPanel.Section>
      ...
      <ActionPanel>
        ...
        <ActionPanel.Section>
          <Action.CopyToClipboard
            ...
            content={`brew install --cask ${cask.name}`}
            shortcut={{ modifiers: ["cmd", "opt"], key: "c" }}
          />
          <Action
            title="Run In Terminal"
            icon={Icon.Terminal}
            onAction={() => {
              runCommandInTerminal(`brew install --cask ${cask.name}`);
            }}
          />
        </ActionPanel.Section>
        <ActionPanel.Section>
    ...
    return (
      <ActionPanel>
        ...
        <ActionPanel.Section>
          <Action.CopyToClipboard
            title="Copy Uninstall Command"
            content={`brew uninstall ${formula.name}`}
            shortcut={{ modifiers: ["cmd", "opt"], key: "c" }}
          />
          <Action
            title="Run In Terminal"
            icon={Icon.Terminal}
            onAction={() => {
              runCommandInTerminal(`brew uninstall ${formula.name}`);
            }}
          />
        </ActionPanel.Section>
        <ActionPanel.Section>
    ...
    return (
      <ActionPanel>
        ...
        <ActionPanel.Section>
          <Action.CopyToClipboard
            title="Copy Install Command"
            content={`brew install ${formula.name}`}
            shortcut={{ modifiers: ["cmd", "opt"], key: "c" }}
          />
          <Action
            title="Run In Terminal"
            icon={Icon.Terminal}
            onAction={() => {
              runCommandInTerminal(`brew install ${formula.name}`);
            }}
          />
        </ActionPanel.Section>
        <ActionPanel.Section>

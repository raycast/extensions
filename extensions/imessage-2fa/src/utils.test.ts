...
describe("Testing matching logic", () => {
  test("Alphanumeric codes", () => {
    expect(extractCode("Chase: DON'T share. Use code 41646271 to complete Extra Security at Sign In. We'll NEVER call to ask for this code. Call us if you didn't request it.")).toBe("41646271");

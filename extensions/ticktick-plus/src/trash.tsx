    ...
    <List isLoading={isLoading} navigationTitle="Trash" searchBarPlaceholder="Search deleted tasks...">
      {tasks.length === 0 && !isLoading ? (
        <List.EmptyView
          ...
          description="TickTick's public API doesn't expose trashed tasks. Open TickTick on the web to view or restore them."
          actions={
            <ActionPanel>
              <Action.OpenInBrowser title="Open Trash in TickTick" url="https://ticktick.com/webapp/#q/all/trash" />
            </ActionPanel>
          }
        />
      ) : (

...
const visionModelName: string = (preferences.useVisionModel && preferences.visionModelName) || "gemini-2.0-flash";
...
export function VisionView(props: AskImageProps) {
  ...
  async function getChatResponse(prompt: string) {
    try {
      ...
      const streamOrCompletion = await gemini.chat.completions.create({

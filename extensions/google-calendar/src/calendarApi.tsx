...
export async function fetchTodayEvents(): Promise<CalendarEvent[]> {
  ...
  const response = await fetch(`${BASE_API_URL}/calendars/primary/events?timeMin=${startOfDay}&timeMax=${endOfDay}&singleEvents=true&orderBy=startTime`, {
...
export async function createGoogleEvent(values: EventFormValues, accessToken: string): Promise<any> {

<div align="center">
  <img
    src="https://github.com/raycast/extensions/blob/main/extensions/google-calendar/assets/google_calendar.png?raw=true"
    width="50"
  />
...
Raycast extension to manage your Google Calenders.

  <p>
    <a href="https://www.raycast.com/tonka3000/google-calendar">
...
- My Week
- Search Calendars
- Open specific events on calendar.google.com

## How to get a Google Calendar OAuth Client ID
...
- Enable the `Google Calendar API`
  ...
  1. Click [here](https://console.cloud.google.com/apis/library/calendar-json.googleapis.com)
...
Now you should be able to manage your Google Calendars with Raycast.

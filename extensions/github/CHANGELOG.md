...
- Add the ability to include or exclude specific repositories from results for My Pull Requests and Unread Notifications Menu Bar commands
- Repository filtering can be enabled in the preferences for My Pull Requests and Unread Notifications Menu Bar commands

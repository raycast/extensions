...
extension links to it and never reproduces it. English entries end on a
**See also** line, with an action to match; turn both off with the
**Link to Etymonline** preference.

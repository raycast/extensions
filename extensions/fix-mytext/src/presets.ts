...
export const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    instruction: "Improve clarity, flow, and readability while preserving the original meaning and overall tone.",
  },
  {
    id: "professional",
    title: "More Professional",
    description: "Tighten the text and shift it toward a professional tone.",
    instruction: "Rewrite the text in a more professional, polished tone while preserving the original meaning.",
  },
  {
    id: "casual",
    title: "More Casual",
    description: "Make the wording sound more natural and conversational.",
    instruction: "Rewrite the text in a more casual, natural tone while preserving the original meaning.",
  },
  {
    id: "concise",
    title: "Make Concise",
    description: "Shorten the text without losing important information.",
    instruction: "Make the text more concise and direct without losing important meaning or changing the intent.",
  },
];

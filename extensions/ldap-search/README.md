...
- Search triggers after a 300 ms debounce, and needs at least 2 characters.
...
| Security | no | Connection security: `Plain (ldap://)`, `StartTLS`, or `LDAPS`. Defaults to Plain |
| LDAP Port | no | Defaults to `389`, or `636` for LDAPS |

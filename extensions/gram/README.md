...
This extension is a fork of the [Raycast extension for Zed](https://www.raycast.com/ewgenius/zed-recent-projects), originally created by ewgenius and contributors 
(tleo19, jylamont, pernielsentikaer, tm.wrnr, true-real-michael, xmorse, ivens_joris).
This project would not have been possible without their work.

## Requirements
- You must have the [Gram editor](https://gram-editor.com) installed on your system.

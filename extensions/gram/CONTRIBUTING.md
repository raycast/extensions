...
4. Generate the test database files:
   ...
   ./scripts/create-fixtures.sh "/Users/<username>/Library/Application Support/Gram/db/0-stable/db.sqlite" 28
   ```

   Note: The v28 fixture is used to test unsupported version detection.

...
import { ApiResponse, Collection, LinkwardenPreferences } from "./interfaces";
...
const fetchLink = async (preferences: LinkwardenPreferences, values: FormValues, collection: Collection) => {
...
export default () => {
  const preferences = getPreferenceValues<LinkwardenPreferences>();

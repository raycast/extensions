...
// The API has ~254 countries; used to fire all page requests in parallel
// instead of waiting for `meta.total`. If the real total ever exceeds this,
// the extra pages are fetched afterwards.

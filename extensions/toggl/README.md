...
## Actions
- Start Toggl Timer (automatically retrieves unique time entries from the last 30 days)
- Stop Toggl Timer
- Create Toggl Timer
...
If you enjoy using Toggl for Raycast and/or want to support further development, feel free to donate below!

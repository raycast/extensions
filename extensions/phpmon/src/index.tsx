  ...
  const items = [
    {
      ...
      subtitle:
        "Opens the window displaying the list of domains registered with Valet.",
      accessoryTitle: null,
      url: "phpmon://list",
    },
    {
    ...
    },
    {
      ...
      subtitle:
        "Attempts to restart all Valet services (php, nginx and dnsmasq).",
      accessoryTitle: null,
    ...
    },
    {
      ...
      subtitle:
        "Attempts to restart the service that corresponds to the linked PHP version.",
      accessoryTitle: null,
    ...
    <List isLoading={false} searchBarPlaceholder="Filter by title...">
      <List.Item
        ...
        actions={
          <ActionPanel>
            <PushAction
              title="Continue to Select a Version"
              target={<SwitchForm />}
            />
          </ActionPanel>
        }
      ...
      {items.map((item) => (
        <List.Item
          ...
          actions={
            <ActionPanel>
              <OpenInBrowserAction
                title="Execute with PHP Monitor"
                url={item.url}
                icon="list-icon.png"
              />
            </ActionPanel>

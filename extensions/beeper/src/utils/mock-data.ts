...
/** Mock chats for Open Chat command screenshots */
...
/** Mock accounts for Connected Accounts command screenshots */
...
/** Mock message search results for Search Messages command screenshots */

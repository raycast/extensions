...
export default function GoalsCommand() {
  ...
  const { isLoading, data: goals, revalidate } = useFetch(`https://www.supahabits.com/api/goals?secret=${secret}`, {
        ...
        <List.EmptyView
          ...
          actions={
            <ActionPanel>
              ...
              <Action.OpenInBrowser title="Open Supahabits Dashboard" url="https://www.supahabits.com/dashboard/goals" />
            </ActionPanel>
          }
        />
      </List>
            ...
            <ActionPanel>
              {goal.status !== "completed" && (
                <Action
                  ...
                  icon={Icon.Checkmark}
                  onAction={async () => {
                    if (await confirmAlert({ title: "Complete Goal", message: "Are you sure you want to mark this goal as complete?" })) {

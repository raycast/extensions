 ...
 * (it returns only text/file), so rich formatting — bold, italics, links —
 * never reaches us through the SDK. We read it directly from the system
 * pasteboard via AppleScript instead.
 *
 ...
 * a string. Returns "" when there is no HTML flavor (e.g. plain text or an image).
 */

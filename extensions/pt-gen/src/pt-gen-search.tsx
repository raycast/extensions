import { Action, ActionPanel, Icon, LaunchProps, LaunchType, List } from "@raycast/api";
...
export default function SearchCommand(props: LaunchProps<{ arguments: SearchArguments }>) {
          ...
          <List.Item
            ...
            actions={
              <ActionPanel>
                <Action.Push
                  title="Show Details"
                  target={<GenCommand arguments={{ url: item.link }} launchType={LaunchType.UserInitiated} />}
                />
              ...
              <List.Item.Detail
                metadata={
                  <List.Item.Detail.Metadata>
                    ...
                    <List.Item.Detail.Metadata.Label title="year" text={item.year} />
                    <List.Item.Detail.Metadata.Label title="subtype" text={item.subtype} />

...
1. Run **Start Work Timer** and enter your total working time (hours + minutes)
   ...
   <img src="media/screenshots/start-timer-form.png" alt="Start Work Timer form" width="500" />
...
3. Click the menu bar item to see the **Started** time and the expected **Expires** time.
   ...
   <img src="media/screenshots/menu-bar-running.png" alt="Menu bar dropdown while running" width="260" />
...
4. **Stop**/ **Resume** the timer at any time — the dropdown then also shows the **Stopped** time, and the menu bar icon
   ...
   <img src="media/screenshots/menu-bar-paused-dropdown.png" alt="Menu bar dropdown while paused" width="260" />

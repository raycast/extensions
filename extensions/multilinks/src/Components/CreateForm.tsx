...
function CreateForm(props: { data?: LinkItem; onCreate?: () => void }) {
  ...
  useEffect(() => {
    (async () => {
      ...
      const browserIds = ["com.google.Chrome", "com.apple.Safari", "com.brave.Browser", "org.mozilla.firefox", "com.microsoft.edgemac", "com.operasoftware.Opera", "org.chromium.Chromium"];

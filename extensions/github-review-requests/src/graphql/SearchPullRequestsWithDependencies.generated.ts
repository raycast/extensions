...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    SearchPullRequestsWithDependencies(variables: SearchPullRequestsWithDependenciesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<SearchPullRequestsWithDependenciesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<SearchPullRequestsWithDependenciesQuery>(SearchPullRequestsWithDependenciesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'SearchPullRequestsWithDependencies');
    }
  };
}

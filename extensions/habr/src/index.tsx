    ...
    <List
      ...
      searchBarAccessory={
        <List.Dropdown
          ...
          defaultValue={"Все потоки. Новые"}
          storeValue
          onChange={(newValue) => setRssLink(newValue as string)}
        >
          <List.Dropdown.Item title={"Все потоки. Новые"} value={"https://habr.com/ru/rss/all/all/?fl=ru"} />
          <List.Dropdown.Item title={"Все потоки. Лучшие"} value={"https://habr.com/ru/rss/best/daily/?fl=ru"} />

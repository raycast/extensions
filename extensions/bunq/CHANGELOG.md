...
- Dates use `{PR_MERGE_DATE}` placeholder until PR is merged
- Version numbers follow [Raycast extension versioning](https://developers.raycast.com/information/versioning)

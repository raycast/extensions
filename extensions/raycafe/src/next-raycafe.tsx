...
const CALENDAR_URL = "https://api2.luma.com/ics/get?entity=calendar&id=cal-KwZeQ0HC9LFQ3Fk";
...
export default function Command() {
  const { data, isLoading, error } = useCachedPromise(fetchUpcomingEvents, []);
  const events = data ?? [];
...
async function fetchUpcomingEvents(): Promise<RaycastEvent[]> {

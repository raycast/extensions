...
export default async function Command(props?: LaunchProps<{ arguments: Arguments.GenerateLoremIpsumSentences }>) {
  ...
  if (error) {
    ...
    const output = lorem.generateSentences(safeNumber);

/** Technical identifiers that must survive masking. Shared, because the
 * invariant belongs to the whole pipeline and was previously locked on the
 * deterministic layer alone, which is how the detector came to mask a
 * Luhn-valid timestamp as a card. */
export const IDENTIFIER_CASES: Array<[string, string]> = [

...
import { CreateEmailAccountRequest, CreateEmailAccountResponse, DeleteEmailAccountRequest, DeleteEmailAccountResponse, ListEmailAccountsInDomainRequest, ListEmailAccountsInDomainResponse } from "../types/email-accounts";
import { CreateDatabaseRequest, CreateDatabaseResponse, DeleteDatabaseRequest, DeleteDatabaseResponse, ListDatabasesInDomainRequest, ListDatabasesInDomainResponse } from "../types/databases";
import { CreateDNSRecordRequest, CreateDNSRecordResponse, DeleteDNSRecordRequest, DeleteDNSRecordResponse, ListDNSRecordsInDomainRequest, ListDNSRecordsInDomainResponse } from "../types/dns-records";
import { ChangeWebsiteLinuxUserPasswordRequest, ChangeWebsiteLinuxUserPasswordResponse, ChangeWebsitePHPVersionRequest, ChangeWebsitePHPVersionResponse, CreateWebsiteRequest, CreateWebsiteResponse, DeleteWebsiteRequest, DeleteWebsiteResponse, ListWebsitesRequest, ListWebsitesResponse } from "../types/websites";
import { CreateChildDomainRequest, CreateChildDomainResponse, DeleteChildDomainRequest, DeleteChildDomainResponse, ListChildDomainsRequest, ListChildDomainsResponse } from "../types/child-domains";
...
export async function listDatabasesInDomain(body: ListDatabasesInDomainRequest) {
  return (await callApi("fetchDatabases", "Fetching Databases", body)) as
    | ErrorResponse
    | ListDatabasesInDomainResponse;
}
export async function createDatabase(body: CreateDatabaseRequest) {
  return (await callApi("submitDBCreation", "Creating Database", body)) as
  | ErrorResponse
  | CreateDatabaseResponse;
}
export async function deleteDatabase(body: DeleteDatabaseRequest) {
  return (await callApi("submitDatabaseDeletion", "Deleting Database", body)) as
    | ErrorResponse
...
export async function createDNSRecord(body: CreateDNSRecordRequest) {
  return (await callApi("addDNSRecord", "Creating DNS Record", body)) as
  | ErrorResponse
  | CreateDNSRecordResponse;
}
export async function deleteDNSRecord(body: DeleteDNSRecordRequest) {
  return (await callApi("deleteDNSRecord", "Deleting DNS Record", body)) as
    | ErrorResponse
...
export async function listWebsites(body: ListWebsitesRequest) {
  return (await callApi("fetchWebsites", "Fetching Websites", body)) as
  | ErrorResponse
  | ListWebsitesResponse;
}
export async function createWebsite(body: CreateWebsiteRequest) {
  return (await callApi("submitWebsiteCreation", "Creating Website", body)) as
  | ErrorResponse
  | CreateWebsiteResponse;
}
export async function deleteWebsite(body: DeleteWebsiteRequest) {
  return (await callApi("submitWebsiteDeletion", "Deleting Website", body)) as
    | ErrorResponse
    | DeleteWebsiteResponse;
}
export async function changeWebsitePHPVersion(body: ChangeWebsitePHPVersionRequest) {
  return (await callApi("changePHP", "Changing Website PHP Version", body)) as ErrorResponse | ChangeWebsitePHPVersionResponse;
}
export async function changeWebsiteLinuxUserPassword(body: ChangeWebsiteLinuxUserPasswordRequest) {
  return (await callApi("ChangeLinuxUserPassword", "Changing Website Linux User Password", body)) as ErrorResponse | ChangeWebsiteLinuxUserPasswordResponse;
}

// Child Domains
export async function getChildDomains(body: ListChildDomainsRequest) {
  return (await callApi("fetchDomains", "Fetching Child Domains", body)) as
  | ErrorResponse

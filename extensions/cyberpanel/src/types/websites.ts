...
export type WebsiteRequestBody = ListWebsitesRequest
| CreateWebsiteRequest
| DeleteWebsiteRequest | ChangeWebsitePHPVersionRequest | ChangeWebsiteLinuxUserPasswordRequest;
export type WebsiteSuccessResponse = ListWebsitesResponse
| CreateWebsiteResponse
| DeleteWebsiteResponse | ChangeWebsitePHPVersionResponse | ChangeWebsiteLinuxUserPasswordResponse;
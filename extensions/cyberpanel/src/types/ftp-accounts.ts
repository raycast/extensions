...
export type FTPAccountRequestBody = ListFTPAccountsInDomainRequest | CreateFTPAccountRequest
| DeleteFTPAccountRequest;
export type FTPAccountSuccessResponse = ListFTPAccountsInDomainResponse

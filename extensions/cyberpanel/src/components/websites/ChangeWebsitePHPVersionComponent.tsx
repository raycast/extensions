...
export default function ChangeWebsitePHPVersion({ childDomain, onWebsitePHPVersionChanged }: ChangeWebsitePHPVersionProps) {
  ...
  return (
    <Form navigationTitle="Change Website PHP Version"
      actions={
        <ActionPanel>

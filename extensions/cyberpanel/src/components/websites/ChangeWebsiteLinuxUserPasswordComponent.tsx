...
export default function ChangeWebsiteLinuxUserPassword({ domain, onLinuxUserPasswordChanged }: ChangeWebsiteLinuxUserPasswordProps) {
  ...
  return (
    <Form navigationTitle="Change Website Linux User Password"
      actions={
        <ActionPanel>

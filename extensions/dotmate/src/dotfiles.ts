...
export const DOTFILES: DotFile[] = [
  ...
  createDotFile('Library/Application Support/Code/User/keybindings.json', 'vscode/keybindings.json'),
  createDotFile('Library/Application Support/Code/User/mcp.json', 'vscode/mcp.json'),
  ...
  // iTerm2
  createDotFile('Library/Preferences/com.googlecode.iterm2.plist', 'iterm2/com.googlecode.iterm2.plist'),
  // Warp
  createDotFile('Library/Preferences/dev.warp.Warp-Stable.plist', 'warp/dev.warp.Warp-Stable.plist'),
  // Terminal.app
  createDotFile('Library/Preferences/com.apple.Terminal.plist', 'terminal/com.apple.Terminal.plist'),

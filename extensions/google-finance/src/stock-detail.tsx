      ...
      metadata={
        <List.Item.Detail.Metadata>
          ...
          <List.Item.Detail.Metadata.Label
            title="Market Cap"
            text={quote.marketCap || "-"}
          />
          <List.Item.Detail.Metadata.Label
            title="Price"
            text={formatMoney(quote.price, quote.currency)}
          />
          <List.Item.Detail.Metadata.Label
            title="52-Week Range"
            text={quote.yearRange || "-"}
          />
          <List.Item.Detail.Metadata.Separator />
          <List.Item.Detail.Metadata.Label
            title="Avg Volume"
            text={quote.avgVolume || "-"}
          />
          <List.Item.Detail.Metadata.Label
            title="Short Interest"
            text={f?.shortInterest || "-"}
          />
          <List.Item.Detail.Metadata.Label
            title="Short % of Float"
            text={f?.shortPercentOfFloat || "-"}
          />
          <List.Item.Detail.Metadata.Separator />
          <List.Item.Detail.Metadata.Label
            title="Enterprise Value"
            text={f?.enterpriseValue || "-"}
          />
          <List.Item.Detail.Metadata.Label
            title="P/E Ratio"
            text={quote.peRatio || "-"}
          ...
          <List.Item.Detail.Metadata.Label
            ...
            text={quote.dividendYield || "-"}
          />
          <List.Item.Detail.Metadata.Separator />
          <List.Item.Detail.Metadata.Label
            title={
              f?.balanceSheetDate
                ? `Balance Sheet (${f.balanceSheetDate})`
                : "Balance Sheet"
            }
            text=""
          />

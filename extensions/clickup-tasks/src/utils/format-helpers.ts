...
import { ItemAccessory, TagListItemProps } from "../types/raycast";
...
/** Format a ClickUp user for display with avatar or initials Uses Raycast's built-in getAvatarIcon utility for consistent avatar generation */
...
export function buildSubtitle(subtaskCount: number) {

...
export default function ImagesMetadata({images}: {images: Image[]}) {
    ...
    {images.map((image, imageIndex) => <Fragment key={imageIndex}>
        ...
        <List.Item.Detail.Metadata.Label title="Caption" text={image.caption || ""} icon={image.caption ? undefined : Icon.Minus} />

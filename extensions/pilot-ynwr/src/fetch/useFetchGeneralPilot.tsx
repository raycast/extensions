...
import { Evnt, Keystone, Pref, Project, ProjectGP, Timer } from '../interfaces/itemsInterfaces'
import { FetchActiveProjects, FetchActiveTimer, FetchAllProjects, FetchGeneralPilotProjects, FetchTodayEvents, FetchTodayKeystones } from './FetchFunctions'
...
const useFetchGeneralPilot = (notion:Client|undefined, needRefresh:boolean) => {
    ...
    const fetch = async (targets:string[], forceRefresh:boolean, apiIDs: ApiIDs) => {
        ...
        const fetchedGPProjects = await FetchGeneralPilotProjects(targets, apiIDs.journal, apiIDs.keystone,fetchedActiveProjects as Project[],forceRefresh, notion)

...
export const strToData = (string:string) => {return JSON.parse(string) as object}
export const dataToStr = (data:object|null) => {return JSON.stringify(data)}
...
export const getConvertTimeItem = (journals:Journal[]) => {
    ...
    if(journals.length!==0) journals.forEach((j:Journal) => {
...
export const getAPIError = (code:string, type:string) => {
    ...
    switch (code) {
        ...
        case 'object_not_found':
            text = "We cannot find your "+type+' page. Check if you authorize the Pilot Extension on Notion for the '+type+' page.'
            break;
        case 'ENOTFOUND':

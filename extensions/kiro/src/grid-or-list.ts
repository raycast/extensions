...
export function ListOrGridSection<T>(
  props: ListOrGridSectionProps,
  context?: T
) {
  return layout === "list"
    ? List.Section(props, context)
    : Grid.Section(props, context);
}
...
export function ListOrGridEmptyView<T>(
  props: ListOrGridEmptyViewProps,
  context?: T
) {
  return layout === "list"
    ? List.EmptyView(props, context)
    : Grid.EmptyView(props, context);
}

type ListOrGridDropdownProps = List.Dropdown.Props | Grid.Dropdown.Props;
export function ListOrGridDropdown<T>(
  props: ListOrGridDropdownProps,
  context?: T
) {
  return layout === "list"
...
export function ListOrGridDropdownSection<T>(
...
export function ListOrGridDropdownItem<T>(
  props: ListOrGridDropdownItemProps,
  context?: T
) {
  return layout === "list"

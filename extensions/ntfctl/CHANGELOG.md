...
- **Clear All Notifications** — Dismiss every visible notification banner (3 strategies, 11-language clear button detection)
- **Peek at Latest Notification** — Rich Detail view showing the newest notification's app, title, and body with Copy and Dismiss actions
- **Dismiss Latest Notification** — Remove only the top-most notification banner

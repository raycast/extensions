      ...
      actions={
        <ActionPanel>
          <ActionPanel.Section>
            ...
            <CopyToClipboardAction title="Copy Deal Email" content={searchResult.ccEmail as string} />
            <CopyToClipboardAction title="Copy Person Email" content={searchResult.email as string} />
          </ActionPanel.Section>
          <ActionPanel.Section>
            <CopyToClipboardAction title="Copy Person Name" content={searchResult.name as string} />
            <CopyToClipboardAction
              title="Copy Person Email"
              content={searchResult.email as string}
              shortcut={{ modifiers: ["cmd"], key: "." }}
            />
            <CopyToClipboardAction title="Copy Person Phone" content={searchResult.phone as string} />
          </ActionPanel.Section>
        </ActionPanel>
      }
    />

...
| [Anytype](https://github.com/anyproto/anytype-mcp) | An MCP server enabling AI assistants to interact with Anytype - your safe haven for digital collaboration - to organize objects, lists, and more through natural language. |

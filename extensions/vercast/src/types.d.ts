...
export type EnvironmentTarget = ("production" | "preview" | "development")[] | "production" | "preview" | "development";

type ProjectEnvironment = Omit<Environment, "id" | "createdAt" | "updatedAt" | "decrypted" | "system"> & {
  id?: string;
  createdAt?: number;
  updatedAt?: number;
};

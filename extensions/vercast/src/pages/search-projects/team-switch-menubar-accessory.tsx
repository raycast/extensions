...
const MenuBarTeamAccessory = ({
  ...
  return (
    <MenuBarExtra.Submenu
      title={`${selectedTeam?.name ?? user?.name ?? "None"}`}
      icon={Icon.TwoPeople}
    >
      ...
      {user && (
        <MenuBarExtra.Item
          ...
          icon={{
            source: Icon.Person,
            tintColor:
              user.username == selectedID ? Color.Green : Color.PrimaryText,
          }}
        ...
        teams?.map((team) => (
          <MenuBarExtra.Item
            ...
            icon={{
              ...
              tintColor:
                team.id == selectedID ? Color.Green : Color.PrimaryText,
            }}

...
import { environment, LaunchType, getPreferenceValues, LocalStorage, showHUD } from "@raycast/api";
...
const setRandomWallpaper = async () => {
  try {
    ...
    if (environment.launchType === LaunchType.UserInitiated) {
      await showHUD(error instanceof Error ? error.message : "Failed to set wallpaper");
    }
  }
};

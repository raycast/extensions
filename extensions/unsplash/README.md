...
**A:** The extension implements pagination so each "page" counts as another API call. To minimze your use of requests, try a different search query if the first couple of pages do not meet your needs.

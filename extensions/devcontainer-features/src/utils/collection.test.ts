...
describe('getFeatureCollectionName', () => {
  it('returns collection name from feature', () => {
    expect(getFeatureCollectionName(mockFeature)).toBe('devcontainers/features');
  });
...
describe('getGitHubRepoUrl', () => {
  it('generates correct GitHub URL', () => {
    expect(getGitHubRepoUrl('devcontainers/features')).toBe('https://github.com/devcontainers/features');
  });
...
describe('getFeatureGitHubUrl', () => {
  it('returns GitHub URL for feature', () => {
    expect(getFeatureGitHubUrl(mockFeature)).toBe('https://github.com/devcontainers/features');
  });

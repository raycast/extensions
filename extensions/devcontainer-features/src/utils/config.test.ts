...
describe('generateFullConfiguration', () => {
  ...
  it('uses first enum value when no default', () => {
    ...
    expect(parsed.features['ghcr.io/devcontainers/features/python:1'].variant).toBe('alpine');
  });
  ...
  it('uses true for boolean without default', () => {
    ...
    expect(parsed.features['ghcr.io/devcontainers/features/python:1'].enableFeature).toBe(true);
  });
  ...
  it('uses empty string for string without default', () => {
    ...
    expect(parsed.features['ghcr.io/devcontainers/features/python:1'].customPath).toBe('');
  });

 ...
 */
export function convertRelativeImagePaths(markdown: string, sourceInfo: string, featureId: string): string {
 ...
 */
export function formatEnumValues(values: string[], maxDisplay: number = 3): string {

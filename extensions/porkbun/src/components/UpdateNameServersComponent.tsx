...
import { DEFAULT_NAMESERVERS } from "../utils/constants";
...
export default function UpdateNameServersComponent({ domain, initialNS, onNameServersUpdated }: UpdateNameServersComponentProps) {
    ...
    return <Form navigationTitle="Update Name Servers" actions={<ActionPanel>
        <Action.SubmitForm icon={Icon.Check} onSubmit={handleSubmit} />        
    </ActionPanel>}>
        <Form.Description title="Domain" text={domain} />
    <Form.TextArea title="Name Servers" placeholder={DEFAULT_NAMESERVERS.join(`\n`)} info="Put one nameserver per line" {...itemProps.ns} />
    </Form>
}
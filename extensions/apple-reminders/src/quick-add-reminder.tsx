...
Here's the JSON Object structure:
{
  ...
  "listId": <Task list ID. Pick it from the following table by finding the list name corresponding to an ID: ${lists}. Don't add a listId if the user hasn't specified a list name. Note that the user can prepend the "@" symbol to list names or use phrases like "in the <list> list", for example, "@work" or "in Work list". Words with "#" (e.g. "#work", "#urgent") are tags and must be placed in "tags", not listId.>,

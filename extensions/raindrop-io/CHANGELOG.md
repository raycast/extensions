...
## [AI Suggestions and Duplicate Detection] - 2025-10-20

### Added: AI-Powered Suggestions
- Introducing AI-powered suggestions for collections and tags.
- Use the "Use AI Tagging" action (Cmd+Shift+A) in the Add Bookmark form to get smart suggestions based on the content of the link.
- You can choose your preferred AI provider (Raycast AI or Gemini) in the extension's preferences.

### Enhanced: Duplicate Bookmark Detection
- When adding a new bookmark, the extension now checks if the link already exists in your Raindrop.io account.
- If a duplicate is found, you are presented with options to update the existing bookmark, view its details, or add it as a new bookmark anyway.

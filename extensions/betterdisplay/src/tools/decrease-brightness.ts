...
type Input = {
  ...
  /**
   * The amount to decrease the brightness by.
...
/**
 * This command allows you to decrease the brightness of a display.
...
export default function tool(input: Input) {
  ...
  return decreaseBrightness(input.tagID, increment);
}

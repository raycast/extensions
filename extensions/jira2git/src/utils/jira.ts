...
type StatusErrors = Record<number, ErrorText>;

const { domain, user, token }: Preference = getPreferenceValues();
export const jiraUrl = `https://${domain}`;
 ...
 */
export const jiraFetchObject = async <Result>(
  path: string,
  params: QueryParams = {},
 ...
 * @return the jira response
 */
const jiraFetch = async (path: string, params: QueryParams = {}, statusErrors?: StatusErrors): Promise<Response> => {

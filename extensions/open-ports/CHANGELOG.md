...
- Kill Listening Process: kill by PID or from the list, with graceful and force kills, exit verification and an
  administrator fallback for processes owned by other users.

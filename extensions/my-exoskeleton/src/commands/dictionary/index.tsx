...
export const DictionaryCommand: FC = withConfig(
  ({ configurations: { dictionaryConnection, dictionarySource } }) => {
              ...
              <List.Item.Detail
                ...
                metadata={
                  <List.Item.Detail.Metadata>
                    <List.Item.Detail.Metadata.Label title="英文全称"
                                                     text={r.enName}/>
                    <List.Item.Detail.Metadata.Label title="中文名称"
                                                     text={r.cnName}/>
                    <List.Item.Detail.Metadata.Label title="缩写"
                                                     text={r.abbr}/>
                    <List.Item.Detail.Metadata.Label title="类型"
                                                     text={r.type}/>
                    <List.Item.Detail.Metadata.Label title="Squad"
                                                     text={r.squad}/>
                  </List.Item.Detail.Metadata>
                }
              />

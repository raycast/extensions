...
import {
  ...
  SCHEMA_NAME,
  TicketDataRow
} from "../../constants/ticket-library";
import { Shortcuts } from "../../constants/shortcut";
import { withConfig } from "../../utils/configurationCenter";

export const TicketLibraryCommand: FC = withConfig(
  ({ configurations: { ticketLibraryConnection } }) => {
              ...
              <List.Item.Detail
                ...
                metadata={
                  <List.Item.Detail.Metadata>
                    ...
                    <List.Item.Detail.Metadata.Label title="ticket open date" text={r.ticketOpenDate ? r.ticketOpenDate : '未知'} />
                  </List.Item.Detail.Metadata>
                }
              />
            }

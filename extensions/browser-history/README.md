...
Search and open Google Chrome, Mozilla Firefox, Safari, Microsoft Edge, Brave, Vivaldi, Arc, Opera, Iridium, Orion, Sidekick, Dia, Helium, Comet, and ChatGPT Atlas tabs from search query based on browser history from all browsers.

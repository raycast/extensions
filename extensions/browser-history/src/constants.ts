...
export const defaultProfilePathHelium = ["Application Support", "net.imput.helium", "Default", "History"];
...
const DownloadTextHelium = `
  ...
  [Click here](https://helium.computer/) if you want to download manually.
`;

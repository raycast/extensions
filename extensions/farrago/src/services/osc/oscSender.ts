...
type SuppertedArgType = number | string | boolean;
...
export class OscSender {
  ...
  protected async send(address: string, args: Array<SuppertedArgType>): Promise<void> {
...
function getOscTypeTag(value: SuppertedArgType, opts?: { throwOnUnknown?: boolean }): string {
  opts ??= {};

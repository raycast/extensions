...
![Enter a value and configure the bit width and display order](media/input-form.png)

![Review bits set to 1 and the complete bit list](media/parse-results.png)
...
2. Enter a value such as `33027`, `0x8103`, or `1000000100000011`.

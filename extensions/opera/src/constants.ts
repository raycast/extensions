...
# 🚨Error: Opera browser has no bookmarks. Please add some bookmarks to continue using this command.
...
export const NOT_INSTALLED_MESSAGE = "Opera not installed";
export const NO_BOOKMARKS_MESSAGE = "Opera has no bookmarks.";

...
export type SocialSetListItem = {
  ...
  twitter?: SocialSetAccountPlatform | null;
  linkedin?: SocialSetAccountPlatform | null;
  instagram?: SocialSetAccountPlatform | null;
  tiktok?: SocialSetAccountPlatform | null;
  teams?: number[];
};

export type SocialSetAccountPlatform = {
...
export type CreateRawDraftRequest = {
  account_id: number;
  platforms: PlatformKey[];
  post_raw_content: string;
  publish_now?: boolean;

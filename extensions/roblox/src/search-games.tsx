...
export default (props: LaunchProps<{ arguments: Arguments.SearchGames }>) => {
    ...
    } = useFetch<SearchResponse>(`https://apis.roblox.com/search-api/omni-search?searchQuery=${encodeURIComponent(debouncedSearchText)}&pageToken=&sessionId=1&pageType=all`)

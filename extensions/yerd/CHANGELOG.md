...
- View Captured Mail command: mail inbox with message viewer and guarded clear
- Manage Proxies command: whole-host proxy and path-rule management
- Yerd Status & Doctor command: live daemon health dashboard with doctor diagnostics and repair

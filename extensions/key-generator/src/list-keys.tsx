        ...
        if (
            ...
            try {
                ...
                if (key.privateKeyPath) {
                    await fs.unlink(key.privateKeyPath);
                }
                showToast({
    ...
    return (
        ...
        >
            <Form.TextField
                id="newName"
                title="New Name"
                defaultValue={props.keyItem.name}
            />
        </Form>
    );
}

...
export default function Command() {
    ...
    async function handleSubmit(values: {
        ...
        try {
            ...
            const pubPath = path.join(sshDir, `${values.filename}.pub`);
            ...
            push(
                <ConfirmationView
                    ...
                    privPath={path.join(sshDir, values.filename)}
                />,
            );
        } catch (error) {
    ...
    return (
        ...
        >
            ...
            >
                <Form.Dropdown.Item
                    value="file"
                    title="📁 Direct File (Standard)"
                />
                <Form.Dropdown.Item
                    value="hardware"
                    title="🔑 Hardware Security Key (FIDO)"
                />
            </Form.Dropdown>
            ...
            <Form.Dropdown
                ...
                title="Algorithm"
                defaultValue={
                    storageMode === "hardware" ? "ed25519-sk" : "ed25519"
                }
            >

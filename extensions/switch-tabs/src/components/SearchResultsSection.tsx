  ...
  return (
    <ActionPanel>
      <Action
        ...
        onAction={async () => {
          ...
          if (inBackground) {
            ...
            sendToSocket({ type: "CREATE_TAB", url: item.url, browser: browserTarget, windowId: windowTarget });
          }
        }}
      />
      <Action
      ...
      <Action
        ...
        onAction={() => {
          sendToSocket({ type: "CREATE_TAB", url: item.url, browser: browserTarget, asPopup: true });
          showToast({ style: Toast.Style.Success, title: "Opened in Popup", message: item.title || item.url });
        }}
      />
      <Action
        ...
        onAction={() => {
          ...
          showToast({ style: Toast.Style.Success, title: "Opened in background", message: item.query });
        }}
      />

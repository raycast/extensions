...
|--------|----------|-------------|
| Copy Password | ⇧↩ | Copy (or fill) the password |
| Copy Username | ↩ | Copy (or fill) the username |
| Copy OTP | ⌘⇧↩ | Copy (or fill) the current one-time code |
...
| Copy secrets | Enabled | Copy secret values to the clipboard; disable to paste at the cursor instead |

...
import {
  ...
  OpenExtensionByIDInQoderAction,
  UninstallExtensionByIDAction,
} from "./components/extension-actions";
import { useLocalExtensions } from "./hooks/extensions";
import { Extension } from "./lib/qoder";
      ...
      actions={
        <ActionPanel>
          <ActionPanel.Section>
            ...
            <OpenExtensionByIDInQoderAction extensionID={getFullExtensionID(e)} />
          </ActionPanel.Section>
          <ActionPanel.Section>

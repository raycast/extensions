...
![A guide about choosing an open source license](media/legal-guide.png)
...
![The actions menu with keyboard shortcuts](media/actions.png)
...
![A guide snoozed until local midnight](media/rest-mode.png)

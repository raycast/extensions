...
export default function Command() {
    ...
    return (
        ...
        >
            <Form.Description title="XML for SVG" text="The validity of the SVG is not checked, as all strings can be encoded into base64. You must ensure the SVG you are loading is already correct." />

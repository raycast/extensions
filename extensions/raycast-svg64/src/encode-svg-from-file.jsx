import { Form, ActionPanel, Action, Clipboard, popToRoot, showHUD, getSelectedFinderItems, LocalStorage } from "@raycast/api";
...
export default function Command() {
    ...
    return (
        ...
        >
            <Form.Description title="SVG File" text="The validity of the SVG is not checked, as all strings can be encoded into base64. You must ensure the SVG you are loading is already correct." />
            <Form.FilePicker title="" {...itemProps.svgFile} allowMultipleSelection={false} />

            <Form.Description title="Format" text={`Format of the copied string. This value is remembered for both File and Text input after you submit the form.

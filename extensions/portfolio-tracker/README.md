...
| ------------- | ------- | -------------------------------------------------------------------------- |
| Base Currency | GBP     | All holdings are converted to this currency for your total portfolio value |
...
All data is stored locally on your Mac using Raycast's built-in storage. No external accounts, no servers, no tracking. Price data is sourced from [Yahoo Finance](https://finance.yahoo.com) — no API key required.

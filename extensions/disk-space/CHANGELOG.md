# Disk Space Changelog

All notable changes to the "Disk Space" extension will be documented in this file.
...
### Added
- **Interactive Storage Browser (`check-disk-space`)**:
...
- **Menu Bar Storage Monitor (`disk-space-monitor`)**:
...
- **System Power Actions**:
  ...
  - Spawn Windows Terminal (`wt.exe`), PowerShell, or macOS Terminal at drive root without shell interpolation.

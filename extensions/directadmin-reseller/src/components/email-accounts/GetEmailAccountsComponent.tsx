              ...
              actions={
                <ActionPanel>
                  <Action.Push
                    ...
                    icon={Icon.Plus}
                    target={<CreateEmailAccountComponent domain={domain} onEmailAccountCreated={getFromApi} userToImpersonate={userToImpersonate} />}
                  />
                </ActionPanel>
              }
            />
                ...
                actions={
                  <ActionPanel>
                    <Action.Push
                      ...
                      icon={Icon.Key}
                      target={<ChangeEmailAccountPasswordComponent email={`${email}@${domain}`} onEmailAccountPasswordChanged={getFromApi} userToImpersonate={userToImpersonate} />}
                    />
                    <Action

...
export default function ResellerIPs() {
    ...
    return <List isLoading={isLoading}>
        {resellerIPs && resellerIPs.map(ip => <List.Item key={ip} title={ip} icon={Icon.Globe} actions={<ActionPanel>
            <Action title="Get Detailed Information" icon={Icon.Info} onAction={() => push(<GetResellerIPInformation ip={ip} />)} />
        </ActionPanel>} />)}
    </List>
}
...
function GetResellerIPInformation({ ip }: GetResellerIPInformationProps) {
    ...
    return <Detail navigationTitle="Get Reseller IP Information" isLoading={isLoading} markdown={`## IP: ${ip}`} metadata={!resellerIPInfo ? undefined : <Detail.Metadata>
        <Detail.Metadata.Label title="Gateway" text={resellerIPInfo.gateway || undefined} icon={resellerIPInfo.gateway ? undefined : Icon.Minus} />
        ...
        <Detail.Metadata.Label title="NS" text={resellerIPInfo.ns || undefined} icon={resellerIPInfo.ns ? undefined : Icon.Minus} />

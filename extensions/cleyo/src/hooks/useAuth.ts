...
import { isAuthenticated, initAuth, openAuthPage, pollForCompletion, disconnect } from "../lib/auth";

export type AuthState = "checking" | "not_connected" | "connecting" | "connected";

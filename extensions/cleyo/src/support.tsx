...
import { ActionPanel, Action, Form, Icon, Toast, closeMainWindow, popToRoot, showToast } from "@raycast/api";
...
export default function SendFeedback() {
  ...
  return (
    <Form
      ...
      actions={
        <ActionPanel>
          <Action.SubmitForm title="Send Feedback" icon={Icon.Envelope} onSubmit={handleSubmit} />
        </ActionPanel>
      }
    >
      ...
      >
        {FEEDBACK_TYPES.map((t) => (
          <Form.Dropdown.Item key={t.value} value={t.value} title={t.title} icon={t.icon} />
        ))}
      </Form.Dropdown>

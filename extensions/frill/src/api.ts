...
import { BodyRequest, SingleErrorResponse, MultiErrorResponse, RequestMethod, SimpleSuccessResponse, ErrorResponse } from "./types";
...
import { CreateTopicRequest, CreateTopicResponse, DeleteTopicResponse, GetTopicsResponse, UpdateTopicRequest, UpdateTopicResponse } from "./types/topics";
...
export async function getIdeas() {
  return (await callApi("ideas", "Fetching Ideas")) as SingleErrorResponse | GetIdeasResponse;
}
...
export async function getTopics() {
  return (await callApi("topics", "Fetching Topics")) as SingleErrorResponse | GetTopicsResponse;
}
...
export async function getFollowers() {
  return (await callApi("followers", "Fetching Followers")) as SingleErrorResponse | GetFollowersResponse;
}
export async function deleteFollower(followerIdx: string) {
  return (await callApi(`followers/${followerIdx}`, "Deleting Follower", "DELETE")) as SingleErrorResponse | DeleteTopicResponse;
}

export async function getAdmins() {
  return (await callApi("admins", "Fetching Admins")) as SingleErrorResponse | GetAdminsResponse;
}
export async function getAnnouncementCategories() {
  return (await callApi("announcement-categories", "Fetching Announcement Categories")) as SingleErrorResponse | GetAnnouncementCategoriesResponse;
}

export async function getStatuses() {
  return (await callApi("statuses", "Fetching Statuses")) as SingleErrorResponse | GetStatusesResponse;
}
export async function deleteStatus(statusIdx: string) {
  return (await callApi(`statuses/${statusIdx}`, "Deleting Status", "DELETE")) as SingleErrorResponse | DeleteStatusResponse;
}

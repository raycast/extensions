...
export default function Command() {
  ...
  return (
    <Form
      actions={
        <ActionPanel>
          <Action.SubmitForm onSubmit={handleSearchTextChange} />
        </ActionPanel>
      }
    >
      <Form.TextArea enableMarkdown id="query" title="Query"></Form.TextArea>
      <Form.Dropdown id="model" title="Model" defaultValue="ERNIE_Bot_Turbo">

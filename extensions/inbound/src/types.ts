...
declare class InboundEmailClient {
    ...
    email: {
        ...
        sent: {
             ...
             */
            reply: (id: string, params: PostEmailReplyRequest, options?: IdempotencyOptions) => Promise<ApiResponse<PostEmailReplyResponse>>;
            /**
         ...
         */
        schedule: (params: PostScheduleEmailRequest, options?: IdempotencyOptions) => Promise<ApiResponse<PostScheduleEmailResponse>>;
        /**
         * List scheduled emails with filtering and pagination
     ...
     */
    quickReply: (emailId: string, message: string, from: string, options?: IdempotencyOptions) => Promise<ApiResponse<PostEmailReplyResponse>>;
    /**
     ...
     */
    scheduleReminder: (to: string, subject: string, when: string, from: string, options?: IdempotencyOptions) => Promise<ApiResponse<PostScheduleEmailResponse>>;
    /**
     ...
     */
    reply: (emailOrId: InboundWebhookEmail | string, replyParams: PostEmailReplyRequest, options?: IdempotencyOptions) => Promise<ApiResponse<PostEmailReplyResponse>>;
    domains: {
        /**
         * Create a new domain
         */
...
export { type ApiResponse, type AttachmentData, type DeleteScheduledEmailResponse, type ErrorResponse, type GetScheduledEmailResponse, type GetScheduledEmailsRequest, type GetScheduledEmailsResponse, type IdempotencyOptions, InboundEmailClient as Inbound, type InboundAttachmentInfo, type InboundEmailAddress, type InboundEmailAttachment, InboundEmailClient, type InboundEmailContent, type InboundEmailHeaders, type InboundParsedEmailData, type InboundWebhookEmail, type InboundWebhookEndpoint, type InboundWebhookHeaders, type InboundWebhookPayload, type InboundWebhookRequest, type PostEmailReplyRequest, type PostEmailReplyResponse, type PostEmailsRequest, type PostEmailsResponse, type PostScheduleEmailRequest, type PostScheduleEmailResponse, type ReactEmailComponent, type ScheduledEmailItem, type SuccessResponse, VERSION, buildQueryString, InboundEmailClient as default, getAttachmentInfo, getEmailHtml, getEmailText, getRecipientAddresses, getSenderInfo, isInboundWebhook, isValidEmail };
export type { GetDomainsResponse, DomainWithStats};
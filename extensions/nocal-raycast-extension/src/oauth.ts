...
const SCOPES =
  'account:read notes:read notes:write events:read events:write offline_access'
...
const client = new OAuth.PKCEClient({
  ...
  description:
    'Connect your nocal account to use notes and meetings in Raycast.'
})
...
function toStoredTokenResponse(

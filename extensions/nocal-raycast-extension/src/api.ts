...
export async function searchNotes(query: string) {
  return await apiRequest<PaginatedResponse<NoteSearchResult>>(
    '/notes/search/',
    {
      searchParams: {
        q: query,
...
export async function listNeedsRsvp() {
  return await apiRequest<PaginatedResponse<NeedsRsvpItem>>(
    '/calendars/primary/unresponded-rsvps/',
...
export async function listUpcomingMeetings() {
  ...
  return await apiRequest<PaginatedResponse<Event>>(
    '/calendars/primary/schedule/',
    {
      searchParams: {

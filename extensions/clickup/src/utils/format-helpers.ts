...
import type { ClickUpPriority, ClickUpTask, ClickUpUser } from "../types/clickup";
import type { ItemAccessory, TagListItemProps } from "../types/raycast";
 ...
 * Uses Raycast's built-in getAvatarIcon utility for consistent avatar generation
 */
 ...
 * Provides consistent accessory building across components
 */
...
/**
 * Build subtitle text with subtask count
 */

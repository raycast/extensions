...
import { countSubtasks, getParentTask, isSubtask } from "../../utils/task-helpers";
...
export function TaskDetail({ task: initialTask }: Props) {
    ...
    <Detail
      ...
      metadata={
        <Detail.Metadata>
          ...
          {subtaskCount > 0 && (
            <>
              <Detail.Metadata.Label text={String(subtaskCount)} title="Subtasks" /> <Detail.Metadata.Separator />
            </>
          )}
          ...
          <Detail.Metadata.Label title="Creator" {...creator} /> <Detail.Metadata.Separator />

...
type Input = {
  /**
   * The exact Remote Config condition name to delete. The condition must not be referenced by any parameter.
   */
  name: string;
  /**
...
/**
 * Delete a Remote Config condition across selected Firebase projects. Requires user confirmation before publishing. Fails if the condition is still referenced by any parameter.
 */

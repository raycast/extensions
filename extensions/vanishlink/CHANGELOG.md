...
### Added
- Initial release of VanishLink Raycast Extension
- Add bookmark from clipboard functionality
- Form-based bookmark addition with automatic title fetching
- Bookmark search and management interface

...
import { environment, Icon, showToast, Action, ActionPanel, List } from "@raycast/api";
        ...
        <List.Section key={category.title} title={category.title}>
          {category.children.map((item) => (
            <List.Item
              ...
              actions={
                <ActionPanel>
                  <Action title="Open" icon={Icon.Redo} onAction={() => handleItemAction(item.pfad)} />
                  <Action
                    title="Delete"
                    icon={Icon.Trash}
                  ...
                  <Action
                    ...
                    onAction={() => exec(`open -R "${item.pfad}"`)}
                  />
                </ActionPanel>
              }
            />

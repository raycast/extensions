...
- Filter results by guides or API reference
- Copy module imports and documentation URLs
- Ask Effect AI questions from a dedicated command
- Use `@effect-docs` in Raycast AI Chat to search guides and API reference

...
Search any word with multiple online dictionaries or translation engines in one place.

## Features

The extension is lightweight and built with the official Raycast [API](https://www.npmjs.com/package/@raycast/api) and [utils](https://www.npmjs.com/package/@raycast/utils).
...
- Youdao API (`Youdao Application ID` and `Youdao Secret Key` required)

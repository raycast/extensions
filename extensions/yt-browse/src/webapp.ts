...
/**
 * Find the YouTube Safari web app path, searching for any .app
 * in ~/Applications whose name contains "YouTube" (case-insensitive).
    ...
    const result = await runAppleScript(`
      tell application "System Events"
        ...
        repeat with f in (every file of folder appsFolder whose name ends with ".app")
          ...
          if fName contains "YouTube" then
 ...
 * Searches for any app containing "YouTube" in ~/Applications.
 */
export async function isWebAppInstalled(): Promise<boolean> {
  ...
  // Search for any YouTube-named web app

...
export const addToFavorites = (item: SearchResult, favorites: SearchResult[], setFavorites: (favorites: SearchResult[]) => void, key: string) => {
...
export const removeFromFavoritesForCoins = (item: SearchResult, favorites: SearchResult[], setFavorites: (favorites: SearchResult[]) => void, key: string) => {
...
export const removeFromFavoritesForWallets = (item: SearchResult, favorites: SearchResult[], setFavorites: (favorites: SearchResult[]) => void, key: string) => {

...
export const addToFavorites = (item: WalletSearchResult, favorites: WalletSearchResult[], setFavorites: (favorites: WalletSearchResult[]) => void, key: string) => {
...
export const removeFromFavoritesForCoins = (item: WalletSearchResult, favorites: WalletSearchResult[], setFavorites: (favorites: WalletSearchResult[]) => void, key: string) => {
...
export const removeFromFavoritesForWallets = (item: WalletSearchResult, favorites: WalletSearchResult[], setFavorites: (favorites: WalletSearchResult[]) => void, key: string) => {

...
export const Kernel_ParallelCompiler: ModuleDoc = {
  functions: [
    ...
    { name: "async/1", type: "function", specs: [], documentation: "Starts a task for parallel compilation.\n" },
  ],
  ...
  types: [
    {
      name: "error/0",
      type: "type",
      specs: ["@type error() :: {file :: Path.t(), Code.position(), message :: String.t()}"],
      documentation: null,
    },
    {
      name: "warning/0",
      type: "type",
      specs: ["@type warning() :: {file :: Path.t(), Code.position(), message :: String.t()}"],
      documentation: null,
    },
    {
      name: "info/0",

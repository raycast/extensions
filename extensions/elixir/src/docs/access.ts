...
export const Access: ModuleDoc = {
  functions: [
    {
      name: "slice/1",
      type: "function",
      specs: ["@spec slice(Range.t()) :: access_fun(data :: list(), current_value :: list())"],
      documentation:
    ...
    },
    {
      name: "pop/2",
      type: "function",
      specs: ["@spec pop(data, key()) :: {value(), data} when data: container()"],
      documentation:
    ...
    },
    {
      name: "at!/1",
      type: "function",
      specs: ["@spec at!(integer()) :: access_fun(data :: list(), current_value :: term())"],
      documentation:
    ...
    },
    {
      name: "all/0",
      type: "function",
      specs: ["@spec all() :: access_fun(data :: list(), current_value :: list())"],
      documentation:
  ...
  callbacks: [
    {
      name: "pop/2",
      type: "callback",
      specs: ["@callback pop(data, key()) :: {value(), data} when data: container()"],
      documentation:
  ...
  types: [
    ...
    { name: "t/0", type: "type", specs: ["@type t() :: container() | nil_container() | any()"], documentation: null },
    { name: "nil_container/0", type: "type", specs: ["@type nil_container() :: nil"], documentation: null },
    {
      name: "container/0",
      type: "type",

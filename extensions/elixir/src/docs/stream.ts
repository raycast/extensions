...
export const Stream: ModuleDoc = {
  functions: [
    {
      name: "zip_with/3",
      type: "function",
      specs: ["@spec zip_with(Enumerable.t(), Enumerable.t(), (term(), term() -> term())) ::\n        Enumerable.t()"],
      documentation:
    ...
    },
    {
      name: "zip/1",
      type: "function",
      specs: ["@spec zip(enumerables) :: Enumerable.t()\n      when enumerables: [Enumerable.t()] | Enumerable.t()"],
      documentation:
    ...
    },
    {
      name: "uniq_by/2",
      type: "function",
      specs: ["@spec uniq_by(Enumerable.t(), (element() -> term())) :: Enumerable.t()"],
      documentation:
    ...
    },
    {
      name: "unfold/2",
      type: "function",
      specs: ["@spec unfold(acc(), (acc() -> {element(), acc()} | nil)) :: Enumerable.t()"],
      documentation:
    ...
    },
    {
      name: "take_while/2",
      type: "function",
      specs: ["@spec take_while(Enumerable.t(), (element() -> as_boolean(term()))) ::\n        Enumerable.t()"],
      documentation:
    ...
    },
    {
      name: "take_every/2",
      type: "function",
      specs: ["@spec take_every(Enumerable.t(), non_neg_integer()) :: Enumerable.t()"],
      documentation:
    ...
    },
    {
      name: "scan/3",
      type: "function",
      specs: ["@spec scan(Enumerable.t(), acc(), (element(), acc() -> any())) :: Enumerable.t()"],
      documentation:
    ...
    },
    {
      name: "scan/2",
      type: "function",
      specs: ["@spec scan(Enumerable.t(), (element(), acc() -> any())) :: Enumerable.t()"],
      documentation:
    ...
    },
    {
      name: "reject/2",
      type: "function",
      specs: ["@spec reject(Enumerable.t(), (element() -> as_boolean(term()))) ::\n        Enumerable.t()"],
      documentation:
    ...
    },
    {
      name: "map_every/3",
      type: "function",
      specs: ["@spec map_every(Enumerable.t(), non_neg_integer(), (element() -> any())) ::\n        Enumerable.t()"],
      documentation:
    ...
    },
    {
      name: "map/2",
      type: "function",
      specs: ["@spec map(Enumerable.t(), (element() -> any())) :: Enumerable.t()"],
      documentation:
    ...
    },
    {
      name: "iterate/2",
      type: "function",
      specs: ["@spec iterate(element(), (element() -> element())) :: Enumerable.t()"],
      documentation:
    ...
    },
    {
      name: "flat_map/2",
      type: "function",
      specs: ["@spec flat_map(Enumerable.t(), (element() -> Enumerable.t())) :: Enumerable.t()"],
      documentation:
    ...
    },
    {
      name: "filter/2",
      type: "function",
      specs: ["@spec filter(Enumerable.t(), (element() -> as_boolean(term()))) ::\n        Enumerable.t()"],
      documentation:
    ...
    },
    {
      name: "each/2",
      type: "function",
      specs: ["@spec each(Enumerable.t(), (element() -> term())) :: Enumerable.t()"],
      documentation:
    ...
    },
    {
      name: "drop_while/2",
      type: "function",
      specs: ["@spec drop_while(Enumerable.t(), (element() -> as_boolean(term()))) ::\n        Enumerable.t()"],
      documentation:
    ...
    },
    {
      name: "drop_every/2",
      type: "function",
      specs: ["@spec drop_every(Enumerable.t(), non_neg_integer()) :: Enumerable.t()"],
      documentation:
    ...
    },
    {
      name: "dedup_by/2",
      type: "function",
      specs: ["@spec dedup_by(Enumerable.t(), (element() -> term())) :: Enumerable.t()"],
      documentation:
    ...
    },
    {
      name: "chunk_every/2",
      type: "function",
      specs: ["@spec chunk_every(Enumerable.t(), pos_integer()) :: Enumerable.t()"],
      documentation: "Shortcut to `chunk_every(enum, count, count)`.\n",
    },
    {
      name: "chunk_by/2",
      type: "function",
      specs: ["@spec chunk_by(Enumerable.t(), (element() -> any())) :: Enumerable.t()"],
      documentation:
  ...
  macros: [],
  types: [
    { name: "timer/0", type: "type", specs: ["@type timer() :: non_neg_integer() | :infinity"], documentation: null },

...
export const Inspect_Opts: ModuleDoc = {
  functions: [
    ...
    },
    {
      ...
      type: "function",
      specs: ["@spec default_inspect_fun((term(), t() -> Inspect.Algebra.t())) :: :ok"],
      documentation:
    ...
    },
    {
      ...
      type: "function",
      specs: ["@spec default_inspect_fun() :: (term(), t() -> Inspect.Algebra.t())"],
  ...
  types: [
    ...
    { name: "color_key/0", type: "type", specs: ["@type color_key() :: atom()"], documentation: null },
  ],
};

...
export const Agent: ModuleDoc = {
  functions: [
    {
      name: "update/5",
      type: "function",
      specs: ["@spec update(agent(), module(), atom(), [term()], timeout()) :: :ok"],
      documentation:
    ...
    },
    {
      name: "start_link/4",
      type: "function",
      specs: ["@spec start_link(module(), atom(), [any()], GenServer.options()) :: on_start()"],
      documentation:
    ...
    },
    {
      name: "start_link/2",
      type: "function",
      specs: ["@spec start_link((-> term()), GenServer.options()) :: on_start()"],
      documentation:
    ...
    },
    {
      name: "start/4",
      type: "function",
      specs: ["@spec start(module(), atom(), [any()], GenServer.options()) :: on_start()"],
      documentation:
    ...
    },
    {
      ...
      type: "function",
      specs: ["@spec get_and_update(agent(), module(), atom(), [term()], timeout()) :: any()"],
      documentation:
    ...
    },
    {
      ...
      type: "function",
      specs: ["@spec get_and_update(agent(), (state() -> {a, state()}), timeout()) :: a\n      when a: var"],
      documentation:
    ...
    },
    {
      name: "get/5",
      type: "function",
      specs: ["@spec get(agent(), module(), atom(), [term()], timeout()) :: any()"],
      documentation:
  ...
  macros: [],
  types: [
    { name: "state/0", type: "type", specs: ["@type state() :: term()"], documentation: "The agent state" },
    {
      name: "agent/0",
      type: "type",
    ...
    },
    {
      name: "on_start/0",
      type: "type",
      specs: ["@type on_start() :: {:ok, pid()} | {:error, {:already_started, pid()} | term()}"],

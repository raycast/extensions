...
export const URI: ModuleDoc = {
  functions: [
    ...
    },
    {
      ...
      type: "function",
      specs: ["@spec query_decoder(binary(), :rfc3986 | :www_form) :: Enumerable.t()"],
      documentation:
    ...
    },
    {
      name: "new/1",
      type: "function",
      specs: ["@spec new(t() | String.t()) :: {:ok, t()} | {:error, String.t()}"],
      documentation:
    ...
    },
    {
      name: "encode_query/2",
      type: "function",
      specs: ["@spec encode_query(Enumerable.t(), :rfc3986 | :www_form) :: binary()"],
      documentation:
    ...
    },
    {
      name: "encode/2",
      type: "function",
      specs: ["@spec encode(binary(), (byte() -> as_boolean(term()))) :: binary()"],
      documentation:
  ...
  macros: [],
  types: [
    { name: "authority/0", type: "type", specs: ["@opaque authority()"], documentation: null },
    {
      name: "t/0",
      type: "type",
      specs: [

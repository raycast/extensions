...
import { formatCurrency, parseDate, mapStatusColor, getInvoiceUrl, getContactUrl } from "./utils/formatting";
    ...
    <List isLoading={isLoading}>
      {invoices.map((invoice) => (
        <List.Item
          ...
          accessories={[
            { text: formatCurrency(invoice.currency, invoice.net_value) },

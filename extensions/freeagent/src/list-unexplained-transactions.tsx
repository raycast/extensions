...
import { formatCurrency, parseDate, getBankTransactionUrl } from "./utils/formatting";
              ...
              {transactions.map((transaction) => {
                ...
                return (
                  <List.Item
                    ...
                    accessories={[
                      { text: formatCurrency(companyInfo?.currency || "GBP", transaction.amount) },
                      ...
                      ...(unexplainedAmount > 0
                        ? [
                            {
                              text: `Unexplained: ${formatCurrency(companyInfo?.currency || "GBP", unexplainedAmount)}`,

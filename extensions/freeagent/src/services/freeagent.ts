...
export async function updateBankTransactionExplanation(
  ...
  console.log("Updating bank transaction explanation with data:", explanationData);
  const data = await makeRequest<BankTransactionExplanationResponse>(
    `/bank_transaction_explanations/${explanationId}`,
    accessToken,
    {
...
export async function updateBankTransaction(
  ...
  console.log("Updating bank transaction:", transactionId, "with data:", transactionData);
  ...
  console.log("Bank transaction updated:", data);

...
export type AddEnterpriseAdminInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
...
export type AddEnterpriseAdminPayload = {
  __typename?: "AddEnterpriseAdminPayload";
...
export type Mutation = {
  ...
  addEnterpriseAdmin?: Maybe<AddEnterpriseAdminPayload>;
...
/** The root query for implementing GraphQL mutations. */
export type MutationAddEnterpriseAdminArgs = {
...
export type Repository = Node &
  ...
  UniformResourceLocatable & {
    ...
    hasAnonymousAccessEnabled: Scalars["Boolean"];
...
export type SearchResultItem = App | Discussion | Issue | Organization | PullRequest | Repository | User;
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    commentsForPullRequest(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CommentsForPullRequestQuery>(CommentsForPullRequestDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "commentsForPullRequest",

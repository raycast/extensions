...
- Optional auto-paste for clipboard images (macOS): pick a target app and the remote path is pasted straight into it when it is frontmost as the transfer finishes, instead of only landing on the clipboard

...
Control [Mac Mouse Fix](https://macmousefix.com) settings directly from Raycast.
...
You need to have [Mac Mouse Fix](https://macmousefix.com) installed and run it at least once before using this extension.

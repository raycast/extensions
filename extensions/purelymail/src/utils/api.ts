import { CreateRoutingRequest, CreateUserRequest, UpdateDomainSettingsRequest, ErrorResponse, Preferences, RequestBody, Response } from "./types"
  ...
  try {
    ...
    if (!apiResponse.ok) {
      return {
          ...
          message: "There was an error with your request. Make sure you are connected to the internet. Please check that your API Token is correct and up-to-date. You can find your API Token in your [Purelymail Account](https://purelymail.com/manage/account). If you need help, please contact support@purelymail.com"
      } as ErrorResponse;
    }

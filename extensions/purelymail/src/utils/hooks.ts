import {
  ...
  export const callApi = async<T> (
    endpoint: string,
    {
      ...
      if (!apiResponse.ok) {
        throw new Error("There was an error with your request. Make sure you are connected to the internet. Please check that your API Token is correct and up-to-date. You can find your API Token in your [Purelymail Account](https://purelymail.com/manage/account). If you need help, please contact support@purelymail.com", {
...
export const useUsers = () => useCachedPromise(
  async () => {
...
export const useRoutingRules = () => useCachedPromise(
  async () => {
...
export const useOwnershipCode = () => useCachedPromise(async () => (await callApi<{ code: string }>("getOwnershipCode")).code, [], { keepPreviousData: true });
  ...
  return error ? (
    ...
    <List isLoading={isLoading}>
      <List.Section title="Required">
        ...
        {ownershipCode && (
          <DNSRecordListItem key={ownershipCode} type="TXT" host="" value={ownershipCode} ownershipCode={ownershipCode} />
        )}
      </List.Section>
...
export function DNSRecordListItem({ type, host, value, ownershipCode }: DNSRecordListItemProps) {
  return <List.Item
  key={value}
  title={value}
  ...
  actions={
    <ActionPanel title="Copy">
      ...
      />
      <Action.CopyToClipboard title="Copy All as JSON" content={JSON.stringify([
        ...REQUIRED_OWNERSHIP_DNS_RECORDS, { type: "TXT", host: "", value: ownershipCode }, ...OPTIONAL_OWNERSHIP_DNS_RECORDS
      ])} />
    </ActionPanel>
  }
/>

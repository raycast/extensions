...
export default function Answer(props: { question: string }) {
  ...
  return <Detail isLoading={isLoading} markdown={data as string} actions={
    <ActionPanel>
      <Action.CopyToClipboard title="Copy to Clipboard" content={data as string} shortcut={{modifiers: ["cmd"], key: "."}} />
    </ActionPanel>
  } metadata={
    <Detail.Metadata>

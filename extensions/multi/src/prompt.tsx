import { Form, ActionPanel, Action, showToast, open, Toast, LocalStorage } from "@raycast/api";
...
export default function Command() {
  ...
  return (
    <Form
      ...
      actions={
        <ActionPanel>
          <Action.SubmitForm onSubmit={handleSubmit} title={`Open ${urls.length} Links`} />
        </ActionPanel>
      }
    >
      <Form.TextArea id="prompt" title="Prompt" placeholder={`Enter the prompt to use across ${urls.length} URLs...`} />
    </Form>
  );
}

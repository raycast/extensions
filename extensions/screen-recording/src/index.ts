...
export default async function main() {
  await runAppleScriptSilently('tell application "QuickTime Player" to activate');
  await runAppleScriptSilently('tell application "QuickTime Player" to start (new screen recording)');
};

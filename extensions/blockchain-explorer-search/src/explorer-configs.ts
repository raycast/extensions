import { ExplorerConfig } from "./interfaces";
 ...
 */
export function getExplorerConfig(baseUrl: string): ExplorerConfig | undefined {
  // Try exact match first
  if (explorerConfigs[baseUrl]) {
    return explorerConfigs[baseUrl];
  }
 ...
 */
export function hasCustomConfig(baseUrl: string): boolean {

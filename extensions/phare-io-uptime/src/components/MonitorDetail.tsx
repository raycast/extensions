...
import { formatSuccessAssertions, getStatusColor, getEffectiveStatus } from "../utils/monitorUtils";
      ...
      metadata={
        <List.Item.Detail.Metadata>
          <List.Item.Detail.Metadata.TagList title="Status">
            <List.Item.Detail.Metadata.TagList.Item text={effectiveStatus} color={getStatusColor(effectiveStatus)} />

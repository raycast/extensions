...
import { Workspace, Meeting } from './types';
...
function SearchResults({
  ...
  const { meetings, isLoading, error, hasMore, loadMore, refresh } = useMeetings(workspace);
  ...
  return (
    <>
      <List.Section title="Search Results" subtitle={`${filteredMeetings.length} meetings found`}>

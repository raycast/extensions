...
export function DatabaseList (props: {databasePage: Page}): JSX.Element {
  ...
  const databaseViewTypes: Record<string,(props: { databaseId: string; databasePages: Page[]; databaseProperties: DatabaseProperty[]; databaseView?: DatabaseView; setRefreshView: any; saveDatabaseView: any; }) => JSX.Element> = {

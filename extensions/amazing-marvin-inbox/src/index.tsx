...
export default function () {
  ...
  async function handleSubmit(values: FormInputs) {
    ...
    if (values.taskdescription == "") return showToast(Toast.Style.Failure, "Couldn't create an empty task");
    ...
    try {
      ...
      showToast(Toast.Style.Failure, `Couldn't create the task: ${error}`);
    }
  }

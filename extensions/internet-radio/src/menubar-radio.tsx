...
import { deleteStation, getAllStations, loadDefaults, modifyStation, playStation } from "./utils";
    ...
    >
      <MenuBarExtra.Section title="Controls">
        ...
        {isPlaying ? tempStationInfo == undefined || currentStationName != Object.keys(tempStationInfo)[0] ? (
          ...
          title="Save Station"
          onAction={async () => {
            await modifyStation("", currentStationName, {}, tempStationInfo[currentStationName], () => null)

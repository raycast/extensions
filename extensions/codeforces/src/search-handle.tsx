        ...
        <Detail.Metadata>
          <Detail.Metadata.TagList title="Max Rating">
            <Detail.Metadata.TagList.Item
              text={convertToTitleCase(`${unString(userData.maxRating)}`)}
              color={getColorHexCode(unString(userData.maxRating))}
            />
            <Detail.Metadata.TagList.Item
          ...
          <Detail.Metadata.TagList title="Current Rank">
            <Detail.Metadata.TagList.Item
              text={convertToTitleCase(`${unString(userData.rating)}`)}
              color={getColorHexCode(unString(userData.rating))}
            />
            <Detail.Metadata.TagList.Item

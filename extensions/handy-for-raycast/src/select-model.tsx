import { Action, ActionPanel, Icon, List, open, showHUD, Keyboard } from "@raycast/api";
          ...
          <List.Item
            ...
            actions={
              <ActionPanel>
                ...
                />
                <Action.ShowInFinder title="Show Model in Finder" path={`${MODELS_DIR}/${model.filename}`} />
                <Action
                  title="Open Handy"
                  icon={Icon.AppWindow}

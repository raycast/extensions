# Vikunja Raycast Extension

Raycast extension for a self-hosted Vikunja instance using API token authentication.

The OpenAPI document fetched from the provided instance is saved at [docs/vikunja-openapi.json](/Users/khotwani/scripts/raycast-extensions/vikunja/docs/vikunja-openapi.json).
...
1. Open the extension folder in Raycast:
   [vikunja](/Users/khotwani/scripts/raycast-extensions/vikunja)
2. Run `npm install`.
...
- `Open in browser` is intentionally not implemented because the OpenAPI schema does not document a task web URL or browser route.

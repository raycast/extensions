...
const methodology = `# How Storage Benchmark Works

Storage Benchmark measures **sequential write** and **sequential read** throughput using a temporary file on the selected local volume.

...
- **Run Storage Benchmark** measures sequential write and read throughput with live progress and cancellation.
- **View Storage History** reviews compatible results, provisional/confirmed baselines, confidence, and recent failures.

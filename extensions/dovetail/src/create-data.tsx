...
export default function CreateData() {
  ...
  async function handleSubmit(values: Values) {
    try {
      ...
      showToast(Toast.Style.Success, "Submitted form", `Successfully created ${title} in Dovetail`);
    } catch (err) {
      const errorMessage = err instanceof Error ? err.message : String(err);
      setError(errorMessage);
  ...
  return (
    ...
    >
      <Form.Description text={error ? `Error: ${error}` : "Create data in your Dovetail project."} />

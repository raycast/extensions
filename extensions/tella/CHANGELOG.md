...
- Handled missing API key in the `@tella` AI tool path with a user-friendly setup message instead of surfacing an unhandled error.

### Changed

- Shortened and clarified the README/store description to better reflect the current command set and setup flow.

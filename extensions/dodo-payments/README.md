...
6. Select your preferred API mode:
   - **Test**: For development and testing (transactions won't be processed)
   - **Live**: For production (real transactions will be processed)
7. Save the settings
...
- 🔐 **Secure Authentication**: API keys are stored securely using Raycast's encrypted preferences
- 🌍 **Environment Support**: Switch between test and live environments
- 📊 **Comprehensive Management**: View, search, and manage all aspects of your Dodo Payments account
- ⚡ **Fast Access**: Quick keyboard shortcuts for common actions
- 📋 **Copy Actions**: Easily copy IDs, amounts, and other important data
- 🔍 **Advanced Search**: Search across all data types with real-time filtering
- 📱 **Native UI**: Uses Raycast's native components for optimal performance

## Security

- API keys are stored locally and encrypted by Raycast
- Keys are never transmitted to external servers except for API calls to Dodo Payments
- You can switch between test and live environments safely

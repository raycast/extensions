...
import { Form, LaunchProps, Clipboard, showToast, Toast, Detail, ActionPanel, Action } from "@raycast/api";
...
export default function Command(props: LaunchProps<{ arguments: Arguments }>) {
  ...
  async function handleCalculate(roundStr: string, nearestStr: string) {
    ...
    await showToast({
      ...
      title: "Rounded!",
      message: `Result ${rounded} copied to clipboard.`,
    });
  }

// Source: (last updated 2022-08-25, 10:58 MESZ)
// https://github.com/tailwindlabs/heroicons.com/blob/master/src/data/tags.js
// https://github.com/tailwindlabs/heroicons.com/blob/bfe88c7683462d6a4aa811604334cade65a6b5da/src/data/tags.js

export default {
  "academic-cap": ["degree", "diploma", "graduation", "hat", "school", "university"],
  ...
  "bolt-slash": ["electric", "electricity", "flash", "lightning", "power", "zap"],
  ...
  "chat-bubble-bottom-center": ["bubble", "comment", "discussion", "message", "response", "speech"],
  "chat-bubble-bottom-center-text": ["bubble", "comment", "discussion", "message", "response", "speech"],
  "chat-bubble-left": ["bubble", "comment", "discussion", "message", "response", "speech"],
  "chat-bubble-left-ellipsis": ["bubble", "comment", "discussion", "message", "response", "speech"],
  "chat-bubble-left-right": ["bubble", "comment", "discussion", "message", "response", "speech"],
  "chat-bubble-oval-left": ["bubble", "comment", "discussion", "message", "response", "speech"],
  "chat-bubble-oval-left-ellipsis": ["bubble", "comment", "discussion", "message", "response", "speech"],

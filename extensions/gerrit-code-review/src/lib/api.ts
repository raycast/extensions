...
import { Project, ProjectBranch } from "./project";
import { Change, Label, ChangeSubmitRequirement } from "./change";
import { User, UserVote } from "./user";
...
export class GerritAPI {
  public gerrit: Gerrit;

  constructor(g: Gerrit) {
    this.gerrit = g;
  }

...
In order to use the Pieces Raycast Extension, you must have <a target="blank" href="https://docs.pieces.app/products/meet-pieces">PiecesOS.</a> We recommend also using the Pieces for Developers desktop app.

...
export default function Command() {
  ...
  useEffect(() => {
    async function fetchItems() {
      try {
        const response = await fetch(`http://127.0.0.1:7777/raycast/search_86?keyword=${searchText}&app_id=HVun9CsH27`);
  ...
  return (
    <Grid
      ...
      throttle={true}
      navigationTitle="搜索五笔编码"
      searchBarPlaceholder="输入单个拼音"
    >

...
export const methods: (Method | PaginatedMethod)[] = [
    ...
    {
        name: "Search Tokens",
        description: "Determine which filters are being used by the query string and what parameters were provided to the filters.",
        category: "Search Methods",
        execute: async (params) => {
    ...
    {
        name: "Create Alert",
        description: "Create a network alert for a defined IP/ netblock which can be used to subscribe to changes/ events that are discovered within that range.",

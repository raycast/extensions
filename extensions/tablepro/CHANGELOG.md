...
- **Run Query**: paste SQL, pick a connection, preview rows in Raycast or open the full grid in TablePro. Mutating queries ask before running.
...
- Workflow: `open-connection-window`, `search-history`.

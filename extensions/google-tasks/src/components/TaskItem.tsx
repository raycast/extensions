...
export default function TaskItem(props: {
  ...
  return (
    <List.Item
      ...
      accessories={[{ date: props.task.due === undefined ? null : new Date(props.task.due) }]}
      detail={
        <List.Item.Detail
          ...
          metadata={
            <List.Item.Detail.Metadata>
              <List.Item.Detail.Metadata.Label
                title={props.task.due === undefined ? "" : new Date(props.task.due).toLocaleString()}
                icon={Icon.Calendar}
              />
      ...
      actions={
        <ActionPanel>
          ...
          <Action title="Delete Task" shortcut={{ modifiers: ["cmd"], key: "backspace" }} onAction={props.onDelete} />
          <Action.Push
            title="Create Task"

"use strict";var g=Object.defineProperty;var C=Object.getOwnPropertyDescriptor;var F=Object.getOwnPropertyNames;var A=Object.prototype.hasOwnProperty;var B=(e,t)=>{for(var r in t)g(e,r,{get:t[r],enumerable:!0})},v=(e,t,r,s)=>{if(t&&typeof t=="object"||typeof t=="function")for(let i of F(t))!A.call(e,i)&&i!==r&&g(e,i,{get:()=>t[i],enumerable:!(s=C(t,i))||s.enumerable});return e};var I=e=>v(g({},"__esModule",{value:!0}),e);var E={};B(E,{default:()=>R});module.exports=I(E);var a=require("@raycast/api");var y=require("util"),S=require("child_process"),l=require("os"),c=require("path"),n=require("fs"),w=(0,y.promisify)(S.exec);function D(e="circle_search",t=".png"){let r=Date.now(),s=Math.floor(Math.random()*1e4);return(0,c.join)((0,l.tmpdir)(),`${e}_${r}_${s}${t}`)}function p(e){try{(0,n.existsSync)(e)&&(0,n.unlinkSync)(e)}catch{}}var N=`
param (
...
`;function O(){let e=[(0,c.resolve)(__dirname,"assets","windows-overlay.ps1"),(0,c.resolve)(__dirname,"..","assets","windows-overlay.ps1"),(0,c.resolve)(__dirname,"..","src","scripts","windows-overlay.ps1")];for(let r of e)if((0,n.existsSync)(r))return{path:r,isTemp:!1};let t=D("overlay",".ps1");return(0,n.writeFileSync)(t,N,"utf8"),{path:t,isTemp:!0}}async function f(){let e=D("snip"),t=(0,l.platform)()==="win32";try{if(t){let r=O(),s=`powershell.exe -NoProfile -ExecutionPolicy Bypass -File "${r.path}" -OutputPath "${e}"`;try{await w(s)}finally{r.isTemp&&p(r.path)}}else await w(`/usr/sbin/screencapture -i -r "${e}"`);return(0,n.existsSync)(e)&&(0,n.statSync)(e).size>0?e:null}catch{return p(e),null}}var d=require("fs"),u=require("path");async function W(e){let t=(0,d.readFileSync)(e),r=(0,u.basename)(e),s=new Blob([t],{type:"image/png"}),i=new FormData;i.append("reqtype","fileupload"),i.append("fileToUpload",s,r);let o=await fetch("https://catbox.moe/user/api.php",{method:"POST",body:i,signal:AbortSignal.timeout(12e3)});if(!o.ok)throw new Error(`Catbox returned HTTP ${o.status}`);let $=(await o.text()).trim();if(!$.startsWith("http"))throw new Error(`Catbox response invalid: ${$}`);return $}async function x(e){let t=(0,d.readFileSync)(e),r=(0,u.basename)(e),s=new Blob([t],{type:"image/png"}),i=new FormData;i.append("file",s,r);let o=await fetch("https://tmpfiles.org/api/v1/upload",{method:"POST",body:i,signal:AbortSignal.timeout(12e3)});if(!o.ok)throw new Error(`TmpFiles returned HTTP ${o.status}`);let $=await o.json();if($.status==="success"&&$.data?.url)return $.data.url.replace("tmpfiles.org/","tmpfiles.org/dl/");throw new Error(`Unexpected TmpFiles response format: ${JSON.stringify($)}`)}async function b(e){try{return await W(e)}catch(t){return console.warn("Primary upload failed, falling back to backup host:",t),await x(e)}}var m=require("@raycast/api"),h={google:{name:"Google Lens",getUrl:e=>`https://lens.google.com/uploadbyurl?url=${encodeURIComponent(e)}`},bing:{name:"Bing Visual Search",getUrl:e=>`https://www.bing.com/images/search?view=detailv2&iss=sbi&FORM=SBIHRP&sbisrc=UrlPaste&q=imgurl:${encodeURIComponent(e)}`},yandex:{name:"Yandex Images",getUrl:e=>`https://yandex.com/images/search?rpt=imageview&url=${encodeURIComponent(e)}`},tineye:{name:"TinEye",getUrl:e=>`https://tineye.com/search?url=${encodeURIComponent(e)}`},baidu:{name:"Baidu Visual Search",getUrl:e=>`https://graph.baidu.com/details?isPageLoad=1&carousel=0&entrance=GENERAL&image=${encodeURIComponent(e)}`}};function G(){return(0,m.getPreferenceValues)().searchEngine||"google"}async function P(e,t){let r=t||G();if(r==="all"){let i=Object.values(h).map(o=>(0,m.open)(o.getUrl(e)));return await Promise.all(i),"All Engines"}let s=h[r]||h.google;return await(0,m.open)(s.getUrl(e)),s.name}async function R(){await(0,a.closeMainWindow)(),await new Promise(t=>setTimeout(t,200));let e=null;try{if(e=await f(),!e)return;await(0,a.showHUD)("\u{1F50D} Searching...");let t=await b(e),r=await P(t);await(0,a.showHUD)(`\u2728 Opened in ${r}`)}catch(t){let r=t instanceof Error?t.message:"Failed to search image";await(0,a.showToast)({style:a.Toast.Style.Failure,title:"Search Failed",message:r})}finally{e&&p(e)}}

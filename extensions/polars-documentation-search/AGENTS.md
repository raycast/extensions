...
This guide helps contributors create and ship updates for the Polars Documentation Search Raycast extension.

## Project Structure & Module Organization

- `src/polars-docs.ts`: main Raycast command entry point for Polars documentation search.
...
5. Edit the command source (`src/index.tsx` in a new template, or `src/polars-docs.ts` in this repo), save, and validate hot reload behavior.

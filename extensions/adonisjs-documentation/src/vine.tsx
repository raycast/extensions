...
const APPID = "4EO90892MT";
const APIKEY = "8b79fa235353b77d6e52727161a5a6ca";
const INDEX = "vinejs";
...
export default function SearchDocumentation() {
  ...
  return (
    ...
    >
      ...
      <List.EmptyView icon="vinejs-logo-128.png" title="Whoops! We did not find any matches." />
    </List>
  );
}

...
declare namespace Preferences {
  ...
  export type ReshuffleMusic = ExtensionPreferences & {}
  /** Preferences accessible in the `stop-music` command */
  export type StopMusic = ExtensionPreferences & {}
  /** Preferences accessible in the `short-meditation` command */
  export type ShortMeditation = ExtensionPreferences & {}
}
...
declare namespace Arguments {
  ...
  export type ReshuffleMusic = {}
  /** Arguments passed to the `stop-music` command */
  export type StopMusic = {}

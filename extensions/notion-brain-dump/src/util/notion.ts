...
const clientId = "0819c92b-d91b-4682-8c9d-06391798866a";
const clientSecret = "secret_xLXEF29Dz4kgamGDTkAReKF5VxKaLY0hVrnAvQ6juIh";
...
export async function fetchPages(search: string) {
  try {
    ...
    const pages = await notion.search({
      ...
      query: search.length === 0 ? undefined : search,
    });

    return pages;
  } catch (e) {
    // handleError(e, "Failed to fetch databases", []);
    throw e;
  }
}

...
*Internal debugging pages* enabled, over the DevTools Protocol on **2026-09-09**.
...
They remain in `paths.ts` marked `isDeprecated`, hidden behind the *Hide Removed URLs* preference.

        ...
        <>
          ...
          {output.connection ? (
            <>
              ...
              <Form.Description title="Autonomous System Number" text={output.connection.autonomous_system_number || '-'} />
              <Form.Description title="Autonomous System Organization" text={output.connection.autonomous_system_organization || '-'} />

...
export default async function TranslateFaCommand() {
  ...
  try {
    ...
    showToast(Toast.Style.Animated, "Translating to Persian...");

    const response = await processText({
      text: selectedText,
      action: "translateToPersian",
    ...
    if (response) {
      ...
      showToast(
        Toast.Style.Success,
        "Translated to Persian and copied to clipboard",
      );
    } else {

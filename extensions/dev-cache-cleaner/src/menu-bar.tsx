    ...
    <MenuBarExtra icon={Icon.HardDrive} title={title} isLoading={isLoading}>
      <MenuBarExtra.Section>
        <MenuBarExtra.Item
          ...
          onAction={() =>
            open(`${process.env.RAYCAST_SCHEME ?? "raycast"}://extensions/Undolog/dev-cache-cleaner/scan-caches`)
          }
        />
        <MenuBarExtra.Item
          ...
          icon={Icon.Trash}
          onAction={() =>
            open(`${process.env.RAYCAST_SCHEME ?? "raycast"}://extensions/Undolog/dev-cache-cleaner/clean-safe-caches`)
          }
        />
      </MenuBarExtra.Section>

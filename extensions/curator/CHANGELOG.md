...
- Hardened the AI recommendation prompt for long catalogs by restating the selection task after the catalog and treating catalog names, descriptions, and triggers as the only evidence source.

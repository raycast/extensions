...
export const getNamespaceUrl = (namespace: Functionv1beta1.Namespace) =>
  `${CONSOLE_URL}/functions/namespaces/${namespace.region}/${namespace.id}`

export const getFunctionUrl = (serverlessfunction: Functionv1beta1.Function) =>
...
export const getLoggingFunctionUrl = (serverlessfunction: Functionv1beta1.Function) =>

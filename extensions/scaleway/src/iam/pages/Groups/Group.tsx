...
import { useAllUsersQuery, useAllApplicationsQuery } from '../../queries'
    ...
    <List.Item.Detail
      metadata={
        <List.Item.Detail.Metadata>
          ...
          <List.Item.Detail.Metadata.Label title="Created At" text={group.createdAt?.toDateString()} />
          <List.Item.Detail.Metadata.Label title="Updated At" text={group.updatedAt?.toDateString()} />
            ...
            <>
              ...
              <List.Item.Detail.Metadata.TagList title="Applications">
                {applications.map((application) => (
                  <List.Item.Detail.Metadata.TagList.Item text={application.name} key={application.id} />
                ))}

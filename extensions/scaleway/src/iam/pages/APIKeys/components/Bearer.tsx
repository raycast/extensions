...
const User = ({ userId }: { userId: IAM.v1alpha1.User['id'] }) => {
  ...
  return (
    <>
      ...
      <List.Item.Detail.Metadata.Label title="User ID" text={userId} icon={{ source: 'dark/iam-user.svg' }} />
      <List.Item.Detail.Metadata.Label title="User Email" text={user?.email} icon={{ source: 'dark/iam-user.svg' }} />
    </>
  )
}

...
export function installDefaultWeights() {
  ...
  return Promise.all([
    ...
    LocalStorage.setItem("https://google.com", 1.08),
    LocalStorage.setItem("https://bing.com", 1.07),
    LocalStorage.setItem("https://stackoverflow.com", 1.08),
    LocalStorage.setItem("https://duckduckgo.com", 1.06),
    LocalStorage.setItem("http://wolframalpha.com", 1.06),
    LocalStorage.setItem("http://chat.openai.com", 1.06),
    LocalStorage.setItem("https://yahoo.com", 1.05),

    LocalStorage.setItem("https://youtube.com", 1.05),

...
This new Raycast extension for URL shortening with support for multiple service providers, history tracking, and comprehensive testing. The extension provides a complete solution for shortening URLs directly from Raycast.

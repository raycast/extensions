...
export default function RunDiskSpeedTestCommand() {
  ...
  if (state.kind === "loading") return <Detail isLoading markdown="# Preparing Disk Speed Test" />;
...
function commandActions(
  ...
  return (
    <ActionPanel>
      ...
      <Action
        title="View Disk Speed History"
        icon={Icon.Clock}
        onAction={() => launchCommand({ name: "view-disk-speed-history", type: LaunchType.UserInitiated })}
      />

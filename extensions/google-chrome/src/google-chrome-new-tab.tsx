import { ActionPanel, popToRoot, closeMainWindow, CopyToClipboardAction, getPreferenceValues, Icon, List, OpenInBrowserAction } from "@raycast/api";
...
async function openNewTab(queryText: string): Promise<boolean> {
  popToRoot();
...
const NewTabActions = (props: { query: query }): ReactElement => {

...
export default async ({ github, context }: API) => {
  ...
  const expectations = "We're currently experiencing high demand and limited capacity. As a result, extension reviews might take longer than usually to get the initial review. Please expect an initial review within 5-10 business days."; 

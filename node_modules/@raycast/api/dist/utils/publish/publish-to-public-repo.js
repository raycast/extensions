...
`+A.html_url;{let z=(f?"Update":"Add")+" "+e.name+" extension";return`
...
Be sure to add as much details as possible in the PR description to accelerate the review. Once it is ready, mark the PR as "Ready for review" and it will be reviewed by the Raycast team shortly.`}}),m&&process.exit(1)}async function Cd(e,r,o,i){re(void 0);try{let a=(r?"Update":"Add")+" "+e.name+" extension",l=await tn(i)?await Io(i):await Io("");return l.length>1?a=`${a}

...
export default function ResetWorkflowForm({ workflowId, runId }: ResetWorkflowFormProps) {
    ...
    async function fetchHistory() {
      try {
        ...
        const resetPoints = history.filter(
          (e) =>
            e.eventType.includes("Workflow Task Completed") ||
            e.eventType.includes("WorkflowTaskCompleted")
        );
  ...
  return (
    ...
    >
      ...
      >
        <Form.Dropdown.Item
          value="RESET_REAPPLY_TYPE_SIGNAL"
          title="Reapply Signals"
          icon={Icon.Message}
        />
        <Form.Dropdown.Item
          value="RESET_REAPPLY_TYPE_ALL_ELIGIBLE"
          title="Reapply All Eligible"
          icon={Icon.Layers}
        />
        <Form.Dropdown.Item
          value="RESET_REAPPLY_TYPE_NONE"
          title="Don't Reapply"

import { Action, ActionPanel, Form, useNavigation, showToast, Toast, Icon, Color } from "@raycast/api";
  ...
  return (
    ...
    >
      ...
      <Form.Checkbox
        ...
        onChange={setShowAdditionalEmails}
      />
      ...
      <Form.Checkbox
        ...
        onChange={setShowAdditionalPhones}
      />

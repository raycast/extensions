...
The extension requests public teardown metadata from `https://nichefund.app`. It does not collect credentials and does not require authentication. Browser links include campaign parameters for aggregate attribution.

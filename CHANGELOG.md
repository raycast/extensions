...
- Custom folders to organize applications, websites, and nested folders
...
- Website support with automatic favicon fetching from 6 sources in parallel
- Refresh Favicon action (`⌘R`) to manually re-fetch icons
...
- Copy as Markdown — URLs with nested folder structure
- Copy as List — plain URLs sorted by length
- Move items between folders with `⌘M`
- Export/Import folders as JSON backups

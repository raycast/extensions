...
6. Update `CHANGELOG.md`, keeping `{PR_MERGE_DATE}` as the release date placeholder.
...
Open the distribution build in Raycast and test both commands, pagination, category filtering, offline errors, and every browser/copy action.

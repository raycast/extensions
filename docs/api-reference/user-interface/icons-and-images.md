...
| Name | Type | Required | Description |
| :--- | :--- | :--- | :--- |
| mask | [`ImageMask`](icons-and-images.md#imagemask) | No | A [ImageMask](icons-and-images.md#imagemask) to apply to the image. |
| source | [`ImageSource`](icons-and-images.md#imagesource) | Yes | The source of the image. |

...
- You have [Node.js](https://nodejs.org) 22.14 or higher installed. A version manager like [fnm](https://github.com/Schniz/fnm) or [nvm](https://github.com/nvm-sh/nvm) makes installing and switching Node versions easy.
